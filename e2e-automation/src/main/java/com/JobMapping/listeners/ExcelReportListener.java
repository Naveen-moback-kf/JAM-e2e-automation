package com.JobMapping.listeners;
...
import com.JobMapping.utils.DailyExcelTracker;
import com.JobMapping.utils.ProgressBarUtil;
...
public class ExcelReportListener implements IExecutionListener, ISuiteListener, ITestListener, IInvokedMethodListener {
    ...
    public void onExecutionStart() {
        ...
        com.JobMapping.utils.KeepAwakeUtil.initialize();
        ...
        com.JobMapping.utils.ScreenshotHandler.resetCounters();
        
        LOGGER.debug("Screenshot performance mode: {}", 
                   com.JobMapping.utils.ScreenshotHandler.isPerformanceModeEnabled() ? "ENABLED" : "DISABLED");
    }
    ...
    public void onExecutionFinish() {
        ...
        if (!isExcelReportingEnabled()) {
            ...
            com.JobMapping.utils.KeepAwakeUtil.shutdown();
            return;
        }
        ...
        LOGGER.debug("Screenshot performance stats: {}", 
                   com.JobMapping.utils.ScreenshotHandler.getPerformanceStats());
        ...
        public String getFormattedExceptionForExcel() {
            ...
            if (stackTrace != null) {
                ...
                for (String line : stackLines) {
                    ...
                    if (line.trim().startsWith("at ") && (line.contains("com.JobMapping") || line.contains("org.testng") || lineCount < 2)) {
