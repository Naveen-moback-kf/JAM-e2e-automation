...
import com.JobMapping.utils.common.VariableManager;

import io.cucumber.testng.FeatureWrapper;
import io.cucumber.testng.PickleWrapper;
import io.cucumber.testng.TestNGCucumberRunner;

@Listeners({com.JobMapping.listeners.ExcelReportListener.class})
public abstract class CustomizeTestNGCucumberRunner extends DriverManager{
    ...
    private void ensureDriverInitialized() {
        if (DriverManager.getDriver() == null) {
            ...
            LOGGER.warn("⚠️ Driver is null in " + runnerName + " - initializing");
