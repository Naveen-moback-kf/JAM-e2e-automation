 ...
 */
public class PO36_SelectAllWithFiltersFunctionality extends BasePageObject {

	private static final Logger LOGGER = LogManager.getLogger(PO36_SelectAllWithFiltersFunctionality.class);

	public PO36_SelectAllWithFiltersFunctionality() {
		super();
	}
	...
	public void verify_only_filtered_profiles_are_selected_after_clearing_all_filters(String screen) {
		...
		int baseline = PO35_SelectAllWithSearchFunctionality.searchResultsCount.get();
		if (baseline == 0) {
