 ...
 */
public class PO40_ValidateSelectAndPublishAllJobProfilesinJAM extends BasePageObject {

	private static final Logger LOGGER = LogManager.getLogger(PO40_ValidateSelectAndPublishAllJobProfilesinJAM.class);

	public PO40_ValidateSelectAndPublishAllJobProfilesinJAM() {
		super();
	}
