...
public class PO26_VerifyJobsMissingDataTipMessage extends BasePageObject {

	private static final Logger LOGGER = LogManager.getLogger(PO26_VerifyJobsMissingDataTipMessage.class);

	public static ThreadLocal<String> initialJobCount = ThreadLocal.withInitial(() -> "NOT_SET");

	public PO26_VerifyJobsMissingDataTipMessage() {
		super();
	}
