...
public class PO10_ValidateScreen1SearchResults extends BasePageObject {

	private static final Logger LOGGER = LogManager.getLogger(PO10_ValidateScreen1SearchResults.class);
	...
	public void user_should_validate_all_search_results_contains_substring_used_for_searching() {
		...
		try {
			...
			PageObjectHelper.handleError(LOGGER, "user_should_validate_all_search_results_contains_substring_used_for_searching",
					"Issue validating search results containing substring: " + PO04_VerifyJobMappingPageComponents.jobnamesubstring.get(), e);
		}
	}
}
