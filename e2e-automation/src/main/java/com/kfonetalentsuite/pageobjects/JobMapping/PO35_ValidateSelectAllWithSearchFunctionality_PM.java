	...
	public void user_should_validate_all_search_results_contains_substring_used_for_searching_in_hcm_sync_profiles_screen() {
		try {
			...
			if (nonMatchingResults == 0) {
				...
				LOGGER.warn(" " + nonMatchingResults + " of " + totalResults + " results do NOT contain '" + searchSubstring + "'");
				ExtentCucumberAdapter.addTestStepLog(" " + nonMatchingResults + " results do not contain '" + searchSubstring + "'");
			}
