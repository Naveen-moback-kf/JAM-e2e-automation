...
public class PO03_ValidateJobmappingHeaderSection extends BasePageObject {

	private static final Logger LOGGER = LogManager.getLogger(PO03_ValidateJobmappingHeaderSection.class);

	private static final By KFONE_CLIENTS_PAGE_TITLE = By.xpath("//h2[text()='Clients']");

	public PO03_ValidateJobmappingHeaderSection() {
		super();
	}
	...
	public void verify_kf_talent_suite_logo_is_displaying() {
		try {
			...
			PageObjectHelper.handleError(LOGGER, "verify_kf_talent_suite_logo_is_displaying", "Issue in displaying KF Talent Suite logo", e);
		}
	}
	...
	public void click_on_kf_talent_suite_logo() {
		try {
			...
			PageObjectHelper.handleError(LOGGER, "click_on_kf_talent_suite_logo", "Issue in clicking on KF Talent Suite Logo", e);
		}
	}
	...
	public void user_should_verify_client_name_is_correctly_displaying() {
		try {
			...
			PageObjectHelper.handleError(LOGGER, "user_should_verify_client_name_is_correctly_displaying", "Issue in displaying correct client name", e);
		}
	}
	...
	public void click_on_client_name_in_job_mapping_ui_header() {
		try {
			...
			PageObjectHelper.handleError(LOGGER, "click_on_client_name_in_job_mapping_ui_header", "Issue in clicking on client name", e);
		}
	}
	...
	public void verify_user_profile_logo_is_displaying_and_clickable() {
		try {
			...
			PageObjectHelper.handleError(LOGGER, "verify_user_profile_logo_is_displaying_and_clickable", "Issue in displaying/clicking User Profile logo", e);
		}
	}
	...
	public void verify_user_profile_menu_is_opened() {
		try {
			...
			PageObjectHelper.handleError(LOGGER, "verify_user_profile_menu_is_opened", "Issue in opening User Profile Menu", e);
		}
	}
	...
	public void click_on_signout_button_in_user_profile_menu() {
		try {
			...
			PageObjectHelper.handleError(LOGGER, "click_on_signout_button_in_user_profile_menu", "Issue in clicking logout button", e);
		}
	}
	...
	public void user_should_be_signed_out_from_the_application() {
		try {
			...
			PageObjectHelper.handleError(LOGGER, "user_should_be_signed_out_from_the_application", "Issue in signing out from Application", e);
		}
	}
}
