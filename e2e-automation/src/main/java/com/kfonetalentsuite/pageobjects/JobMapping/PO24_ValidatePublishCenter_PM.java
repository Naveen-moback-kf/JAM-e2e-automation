	...
	public void verify_details_of_the_recently_downloaded_job_profiles_in_job_profile_history_screen() {
		try {
			...
			LOGGER.info("Below are the details of the Recently Downloaded Job Profile in Job Profile History screen : \n "
					+ jphHeader1.getText().split(" â–¼")[0] + " : " + jphProfilesCountinRow1.getText() + "   "
					+ jphHeader2.getText().split(" â–¼")[0] + " : " + jphAccessedByinRow1.getText() + "   "
					+ jphHeader3.getText().split(" â–¼")[0] + " : " + jphAccessedDateinRow1.getText() + "   "
					+ jphHeader4.getText().split(" â–¼")[0] + " : " + jphActionTakeninRow1.getText()+ "   "
					+ jphHeader5.getText().split(" â–¼")[0] + " : " + jphStatusinRow1.getText());
	...
	public void user_should_verify_first_thirty_job_profiles_in_default_order_before_applying_sorting_in_job_profile_history_screen() {
		try {
			...
			for(int i=1; i<= 30; i++) {
				...
				LOGGER.info(jphHeader1.getText().split(" â–¼")[0] + " : " + jphProfilesCount.getText() + "   "
						+ jphHeader2.getText().split(" â–¼")[0] + " : " + jphAccessedBy.getText() + "   "
						+ jphHeader3.getText().split(" â–¼")[0] + " : " + jphAccessedDate.getText() + "   "
						+ jphHeader4.getText().split(" â–¼")[0] + " : " + jphActionTaken.getText() + "   "
						+ jphHeader5.getText().split(" â–¼")[0] + " : " + jphStatus.getText());
				ExtentCucumberAdapter.addTestStepLog(jphHeader1.getText().split(" â–¼")[0] + " : " + jphProfilesCount.getText() + "   "
						+ jphHeader2.getText().split(" â–¼")[0] + " : " + jphAccessedBy.getText() + "   "
						+ jphHeader3.getText().split(" â–¼")[0] + " : " + jphAccessedDate.getText() + "   "
						+ jphHeader4.getText().split(" â–¼")[0] + " : " + jphActionTaken.getText() + "   "
						+ jphHeader5.getText().split(" â–¼")[0] + " : " + jphStatus.getText());
