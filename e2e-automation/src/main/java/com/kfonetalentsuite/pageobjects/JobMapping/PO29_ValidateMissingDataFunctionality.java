 ...
 */
public class PO29_ValidateMissingDataFunctionality extends BasePageObject {

	private static final Logger LOGGER = LogManager.getLogger(PO29_ValidateMissingDataFunctionality.class);
	...
	public PO29_ValidateMissingDataFunctionality() {
		super();
	}
