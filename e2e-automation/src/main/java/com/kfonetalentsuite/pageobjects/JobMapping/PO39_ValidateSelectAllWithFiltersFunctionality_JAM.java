...
public class PO39_ValidateSelectAllWithFiltersFunctionality_JAM extends BasePageObject {
	...
	public void user_should_scroll_down_to_view_last_filtered_result_in_job_mapping_screen_for_feature39() {
		try {
			...
			PageObjectHelper.log(LOGGER, "Loaded " + currentCount + " filtered results");
		} catch (Exception e) {
			LOGGER.error(
	...
	public void user_should_validate_all_filtered_results_match_the_applied_filter_in_job_mapping_screen_for_feature39() {
		try {
			...
			if (totalResults == 0) {
				...
				PageObjectHelper.log(LOGGER, " No profile elements found - Filter may have returned 0 results");
				...
				PageObjectHelper.log(LOGGER, " All " + totalResults + " results validated for filter: "
				...
				PageObjectHelper.log(LOGGER, " " + nonMatchingResults + " results could not be validated");
			}
	...
	public void verify_only_filtered_profiles_are_selected_after_clearing_all_filters_in_job_mapping_screen() {
		...
		try {
			...
			if (filterResultsCount.get() == 0) {
				...
				PageObjectHelper.log(LOGGER, " No filter results to verify");
				return;
			}
	...
	public void apply_different_filter_for_alternative_validation_in_job_mapping_screen_for_feature39() {
		try {
			...
			if (firstFilterType.equals("Grades")) {
				...
				try {
					...
					if (!gradesOptions.isEmpty()) {
						...
						PageObjectHelper.log(LOGGER, " Using: " + secondFilterType.get() + " = " + secondFilterValue.get()
			...
			PageObjectHelper.log(LOGGER, "Failed to apply different filter");
		}
	}
