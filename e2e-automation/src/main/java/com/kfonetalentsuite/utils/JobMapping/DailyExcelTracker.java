...
public class DailyExcelTracker {
     ...
     * Searches both root features directory AND subdirectories (e.g., JobMapping)
     * Examples: 01 -> 01KFoneLogin.feature, 02 -> JobMapping/02ValidateAddMoreJobsFunctionality.feature
     */
    private static String mapRunnerToFeatureFile(String runnerNumber) {
        ...
        LOGGER.error("NO FEATURE FILE FOUND - No feature file found for runner number: {} in features directory or subdirectories", runnerNumber);
        return null;
    }
    ...
    private static String generateEnhancedBusinessFriendlyComment(ScenarioDetail scenario, String scenarioName, FeatureResult feature) {
        ...
        if (status.contains("PASSED")) {
            ...
            com.kfonetalentsuite.listeners.ExcelReportListener.PerformanceMetrics perfMetrics = 
                com.kfonetalentsuite.listeners.ExcelReportListener.getPerformanceMetrics(scenarioName);
    ...
    private static String getActualSkipExceptionMessage(ScenarioDetail scenario, String scenarioName) {
        try {
            ...
            String directSkipReason = com.kfonetalentsuite.listeners.ExcelReportListener.getSkipReasonByScenarioName(scenarioName);
            ...
            String prefixSkipReason = com.kfonetalentsuite.listeners.ExcelReportListener.getSkipReasonByScenarioName(withPrefix);
            ...
            if (scenario != null && scenario.scenarioName != null && !scenario.scenarioName.equals(scenarioName)) {
                String detailSkipReason = com.kfonetalentsuite.listeners.ExcelReportListener.getSkipReasonByScenarioName(scenario.scenarioName);
