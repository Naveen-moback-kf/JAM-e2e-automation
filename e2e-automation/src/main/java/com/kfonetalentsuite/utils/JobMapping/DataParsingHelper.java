 ...
 * 
 * Extracted from DailyExcelTracker to reduce complexity and improve reusability.
 * Handles XML/JSON parsing, string extraction, and data conversion operations.
 */
public class DataParsingHelper {
    ...
    public static String makeBusinessFriendly(String technicalName) {
        ...
        return technicalName
            .replaceAll("([A-Z])", " $1")  // Add spaces before capitals
            .replaceAll("_", " ")          // Replace underscores with spaces
            .replaceAll("\\s+", " ")       // Normalize spaces
            .trim()
            .replaceFirst("^.", technicalName.substring(0, 1).toUpperCase()); // Capitalize first letter
    }
}
