...
/**
 * Helper class for headless-compatible click operations. Ensures elements are
...
public class HeadlessClickHelper {
	...
	/**
	 * Clicks an element with headless-compatible scrolling and multiple fallback
	 * methods.
	 * 
	...
	/**
	 * Waits for element to be clickable, scrolls into view, then clicks. Combines
	 * wait + scroll + click in one method.
	 * 
	 * @param element        The WebElement to click
	...
	/**
	 * Checks if an element is in the viewport (visible area). Useful for debugging
	 * scroll issues.
	 * 
