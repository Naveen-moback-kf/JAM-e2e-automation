...
public class SD12_RecommendedProfileDetails {
	PageObjectManager validateRecommendedProfileDetails = new PageObjectManager();
	...
	public void search_for_job_profile_with_view_other_matches_button() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().search_for_job_profile_with_view_other_matches_button();
	}
	...
	public void user_should_verify_organization_job_name_and_job_code_values_of_job_profile_with_view_other_matches_button() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().user_should_verify_organization_job_name_and_job_code_values_of_job_profile_with_view_other_matches_button();
	}
	...
	public void user_should_verify_organization_job_grade_and_department_values_of_job_profile_with_view_other_matches_button() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().user_should_verify_organization_job_grade_and_department_values_of_job_profile_with_view_other_matches_button();
	}
	...
	public void user_should_verify_organization_job_function_or_sub_function_of_job_profile_with_view_other_matches_button() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().user_should_verify_organization_job_function_or_sub_function_of_job_profile_with_view_other_matches_button();
	}
	...
	public void click_on_matched_profile_of_job_profile_with_view_other_matches_button() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().click_on_matched_profile_of_job_profile_with_view_other_matches_button();
	}
	...
	public void verify_user_navigated_to_job_comparison_page() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().verify_user_navigated_to_job_comparison_page();
	}
	...
	public void user_should_validate_organization_job_grade_department_and_function_or_subfunction_in_job_comparison_page() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().user_should_validate_organization_job_grade_department_and_function_or_subfunction_in_job_comparison_page();
	}
	...
	public void user_should_verify_recommended_profile_name_matches_with_matched_success_profile_name() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().user_should_verify_recommended_profile_name_matches_with_matched_success_profile_name();
	}
	...
	public void user_should_verify_recommended_tag_and_select_button_is_displaying_on_the_profile() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().user_should_verify_recommended_tag_and_select_button_is_displaying_on_the_profile();
	}
	...
	public void validate_recommended_profile_grade_matches_with_matched_success_profile_grade() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_grade_matches_with_matched_success_profile_grade();
	}
	...
	public void validate_recommended_profile_level_sublevels_matches_with_matched_success_profile_level_sublevels() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_level_sublevels_matches_with_matched_success_profile_level_sublevels();
	}
	...
	public void validate_recommended_profile_function_subfunction_matches_with_matched_success_profile_function_subfunction() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_function_subfunction_matches_with_matched_success_profile_function_subfunction();
	}
	...
	public void validate_recommended_profile_seniority_level_matches_with_matched_success_profile_seniority_level() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_seniority_level_matches_with_matched_success_profile_seniority_level();
	}
	...
	public void validate_recommended_profile_managerial_experience_matches_with_matched_success_profile_managerial_experience() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_managerial_experience_matches_with_matched_success_profile_managerial_experience();
	}
	...
	public void validate_recommended_profile_education_matches_with_matched_success_profile_education() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_education_matches_with_matched_success_profile_education();
	}
	...
	public void validate_recommended_profile_general_experience_matches_with_matched_success_profile_general_experience() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_general_experience_matches_with_matched_success_profile_general_experience();
	}
	...
	public void validate_recommended_profile_role_summary_matches_with_matched_success_profile_role_summary() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_role_summary_matches_with_matched_success_profile_role_summary();
	}
	...
	public void validate_recommended_profile_responsibilities_matches_with_matched_success_profile_responsibilities() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_responsibilities_matches_with_matched_success_profile_responsibilities();
	}
	...
	public void validate_recommended_profile_behavioural_competencies_matches_with_matched_success_profile_behavioural_competencies() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_behavioural_competencies_matches_with_matched_success_profile_behavioural_competencies();
	}
	...
	public void validate_recommended_profile_skills_matches_with_matched_success_profile_skills() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_recommended_profile_skills_matches_with_matched_success_profile_skills();
	}
	...
	public void verify_profile_header_matches_with_matched_profile_name() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().verify_profile_header_matches_with_matched_profile_name();
	}
	...
	public void verify_profile_details_displaying_on_the_popup() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().verify_profile_details_displaying_on_the_popup();
	}
	...
	public void user_should_verify_profile_level_dropdown_is_available_and_validate_levels_present_inside_dropdown() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().user_should_verify_profile_level_dropdown_is_available_and_validate_levels_present_inside_dropdown();
	}

	@Then("Validate Role Summary is displaying")
	public void validate_role_summary_is_displaying() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_role_summary_is_displaying();
	}

	@Then("Validate data in RESPONSIBILITIES screen")
	public void validate_data_in_responsibilities_tab() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_data_in_responsibilities_tab();
	}
	...
	public void validate_data_in_behavioural_competencies_tab() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_data_in_behavioural_competencies_tab();
	}

	@Then("Validate data in SKILLS screen")
	public void validate_data_in_skills_tab() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().validate_data_in_skills_tab();
	}
	...
	public void user_should_verify_publish_profile_button_is_available_on_popup_screen() throws IOException {
		validateRecommendedProfileDetails.getRecommendedProfileDetails().user_should_verify_publish_profile_button_is_available_on_popup_screen();
	}
