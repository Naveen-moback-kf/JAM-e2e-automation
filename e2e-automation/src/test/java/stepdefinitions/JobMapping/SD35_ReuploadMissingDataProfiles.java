...
public class SD35_ReuploadMissingDataProfiles {
	...
	PageObjectManager reuploadMissingDataProfiles = new PageObjectManager();
	...
	public void verify_reupload_button_is_displayed_on_jobs_missing_data_screen() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().verify_reupload_button_is_displayed_on_jobs_missing_data_screen();
	}
	...
	public void click_on_reupload_button_in_jobs_missing_data_screen() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().click_on_reupload_button_in_jobs_missing_data_screen();
	}
	...
	public void create_csv_file_with_extracted_profiles_in_job_catalog_format() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().create_csv_file_with_extracted_profiles_in_job_catalog_format();
	}
	...
	public void save_csv_file_as_in_test_resources_folder(String fileName) throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().save_csv_file_as_in_test_resources_folder(fileName);
	}
	...
	public void verify_csv_file_is_created_successfully_with_correct_headers() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().verify_csv_file_is_created_successfully_with_correct_headers();
	}
	...
	public void verify_csv_file_contains_extracted_profile_data() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().verify_csv_file_contains_extracted_profile_data();
	}
	...
	public void csv_file_with_missing_data_profiles_exists() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().csv_file_with_missing_data_profiles_exists();
	}
	...
	public void read_the_exported_csv_file_with_missing_data_profiles() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().read_the_exported_csv_file_with_missing_data_profiles();
	}
	...
	public void identify_profiles_with_missing_grade_value_in_csv() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().identify_profiles_with_missing_grade_value_in_csv();
	}
	...
	public void identify_profiles_with_missing_department_value_in_csv() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().identify_profiles_with_missing_department_value_in_csv();
	}
	...
	public void identify_all_profiles_with_any_missing_values_in_csv() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().identify_all_profiles_with_any_missing_values_in_csv();
	}
	...
	public void fill_missing_grade_values_with_appropriate_grade_codes() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().fill_missing_grade_values_with_default_grade("JGL01");
	}
	...
	public void fill_missing_department_values_with_appropriate_department_names() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().fill_missing_department_values_with_default_department("Engineering");
	}
	...
	public void fill_missing_job_family_values_with_default_value_general() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().fill_missing_job_family_values_with_default_value("General");
	}
	...
	public void fill_missing_job_sub_family_values_with_default_value_operations() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().fill_missing_job_sub_family_values_with_default_value("Operations");
	}
	...
	public void save_the_updated_csv_file_with_filled_grade_data() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().save_the_updated_csv_file_with_filled_data();
	}
	...
	public void verify_updated_csv_file_has_no_empty_grade_values() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().verify_updated_csv_file_has_no_empty_grade_values();
	}
	...
	public void verify_updated_csv_file_has_no_empty_department_values() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().verify_updated_csv_file_has_no_empty_department_values();
	}
	...
	public void wait_for_backend_processing_and_refresh_job_mapping_page() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().wait_and_refresh_job_mapping_page_after_upload();
	}
	...
	public void search_for_first_reuploaded_profile_by_job_name_from_csv() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().search_for_first_reuploaded_profile_by_job_name_from_csv();
	}
	...
	public void search_for_first_reuploaded_profile_by_job_code_in_missing_data_screen() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().search_for_first_reuploaded_profile_by_job_code_in_missing_data_screen();
	}
	...
	public void verify_profile_is_found_in_job_mapping_search_results() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().verify_profile_is_found_in_job_mapping_search_results();
	}
	...
	public void verify_profile_does_not_display_missing_data_info_icon() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().verify_profile_does_not_display_missing_data_info_icon();
	}
	...
	public void verify_profile_displays_the_corrected_data_values() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().verify_profile_displays_the_corrected_data_values();
	}
	...
	public void verify_profile_is_not_found_in_jobs_missing_data_screen() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().verify_profile_is_not_found_in_jobs_missing_data_screen();
	}
	...
	public void upload_generated_csv_file_using_browse_files_button() throws IOException {
		reuploadMissingDataProfiles.getReuploadMissingDataProfiles().upload_generated_csv_file();
	}
}
