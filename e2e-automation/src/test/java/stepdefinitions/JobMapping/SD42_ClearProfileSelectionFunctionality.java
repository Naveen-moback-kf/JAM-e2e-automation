...
/**
 * Step Definitions for Clear Profile Selection Functionality
 * 
 ...
 */
public class SD42_ClearProfileSelectionFunctionality extends DriverManager {
	
	private PageObjectManager pageObjectManager = new PageObjectManager();
	
	public SD42_ClearProfileSelectionFunctionality() {
		super();
	}
