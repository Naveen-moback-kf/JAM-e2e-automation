...
public class SD17_MapDifferentSPtoProfile {
	...
	public void user_should_search_for_job_profile_with_search_a_different_profile_button_on_mapped_success_profile() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_search_for_job_profile_with_search_a_different_profile_button_on_mapped_success_profile();
	}
	...
	public void user_should_verify_organization_job_name_and_job_code_values_of_job_profile_with_search_a_different_profile_button() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_organization_job_name_and_job_code_values_of_job_profile_with_search_a_different_profile_button();
	}
	...
	public void user_should_verify_organization_job_grade_and_department_values_of_job_profile_with_search_a_different_profile_button() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_organization_job_grade_and_department_values_of_job_profile_with_search_a_different_profile_button();
	}
	...
	public void user_should_verify_organization_job_function_or_sub_function_of_job_profile_with_search_a_different_profile_button() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_organization_job_function_or_sub_function_of_job_profile_with_search_a_different_profile_button();
	}
	...
	public void click_on_mapped_profile_of_job_profile_with_search_a_different_profile_button() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().click_on_mapped_profile_of_job_profile_with_search_a_different_profile_button();
	}
	...
	public void verify_mapped_profile_details_popup_is_displayed() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().verify_mapped_profile_details_popup_is_displayed();
	}
	...
	public void user_is_on_profile_details_popup_of_manually_mapped_profile() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_is_on_profile_details_popup_of_manually_mapped_profile();
	}
	...
	public void verify_profile_header_matches_with_mapped_profile_name() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().verify_profile_header_matches_with_mapped_profile_name();
	}
	...
	public void verify_mapped_profile_details_displaying_on_the_popup() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().verify_mapped_profile_details_displaying_on_the_popup();
	}
	...
	public void user_should_verify_profile_level_dropdown_is_available_and_validate_levels_present_inside_dropdown_of_mapped_profile() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_profile_level_dropdown_is_available_and_validate_levels_present_inside_dropdown_of_mapped_profile();
	}
	...
	public void validate_role_summary_of_mapped_profile_is_displaying() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_role_summary_of_mapped_profile_is_displaying();
	}
	...
	public void validate_data_in_responsibilities_tab_of_mapped_profile() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_data_in_responsibilities_tab_of_mapped_profile();
	}
	...
	public void validate_data_in_behavioural_competencies_tab_of_mapped_profile() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_data_in_behavioural_competencies_tab_of_mapped_profile();
	}
	...
	public void validate_data_in_skills_tab_of_mapped_profile() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_data_in_skills_tab_of_mapped_profile();
	}
	...
	public void user_should_verify_publish_profile_button_is_available_on_popup_screen_of_mapped_profile() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_publish_profile_button_is_available_on_popup_screen_of_mapped_profile();
	}
	...
	public void click_on_close_button_in_profile_details_popup_of_mapped_profile() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().click_on_close_button_in_profile_details_popup_of_mapped_profile();
	}
	...
	public void click_on_search_a_different_profile_button_on_mapped_success_profile() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().click_on_search_a_different_profile_button_on_mapped_success_profile();
	}
	...
	public void user_should_be_navigated_to_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_be_navigated_to_manual_job_mapping_screen();
	}
	...
	public void verify_organization_job_details_in_manual_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().verify_organization_job_details_in_manual_mapping_screen();
	}
	...
	public void user_should_verify_last_saved_profile_name_is_displaying_in_manual_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_last_saved_profile_name_is_displaying_in_manual_mapping_screen();
	}
	...
	public void click_on_last_saved_profile_name_in_manual_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().click_on_last_saved_profile_name_in_manual_mapping_screen();
	}
	...
	public void user_should_verify_last_saved_profile_name_in_manual_mapping_screen_matches_with_profile_name_in_details_popup() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_last_saved_profile_name_in_manual_mapping_screen_matches_with_profile_name_in_details_popup();
	}
	...
	public void user_should_verify_profile_level_dropdown_is_available_on_last_saved_success_profile_and_validate_levels_present_inside_dropdown() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_profile_level_dropdown_is_available_on_last_saved_success_profile_and_validate_levels_present_inside_dropdown();
	}
	...
	public void validate_last_saved_success_profile_role_summary_matches_with_profile_role_summary_in_details_popup() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_last_saved_success_profile_role_summary_matches_with_profile_role_summary_in_details_popup();
	}
	...
	public void validate_last_saved_success_profile_details_matches_with_profile_details_in_details_popup() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_last_saved_success_profile_details_matches_with_profile_details_in_details_popup();
	}
	...
	public void validate_last_saved_success_profile_responsibilities_matches_with_profile_responsibilities_in_details_popup() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_last_saved_success_profile_responsibilities_matches_with_profile_responsibilities_in_details_popup();
	}
	...
	public void validate_last_saved_success_profile_behavioural_competencies_matches_with_profile_behavioural_competencies_in_details_popup() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_last_saved_success_profile_behavioural_competencies_matches_with_profile_behavioural_competencies_in_details_popup();
	}
	...
	public void validate_last_saved_success_profile_skills_macthes_with_profile_skills_in_details_popup() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_last_saved_success_profile_skills_macthes_with_profile_skills_in_details_popup();
	}
	...
	public void search_for_success_profile_in_manual_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().search_for_success_profile_in_manual_mapping_screen();
	}
	...
	public void select_first_sucess_profile_from_search_results_in_manual_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().select_first_sucess_profile_from_search_results_in_manual_mapping_screen();
	}
	...
	public void verify_success_profile_is_added_in_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().verify_success_profile_is_added_in_manual_job_mapping_screen();
	}
	...
	public void user_should_verify_profile_level_dropdown_is_available_and_validate_levels_present_inside_dropdown_in_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_profile_level_dropdown_is_available_and_validate_levels_present_inside_dropdown_in_manual_job_mapping_screen();
	}
	...
	public void change_profile_level_in_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().change_profile_level_in_manual_job_mapping_screen();
	}
	...
	public void validate_role_summary_is_displaying_in_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_role_summary_is_displaying_in_manual_job_mapping_screen();
	}
	...
	public void verify_profile_details_displaying_in_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().verify_profile_details_displaying_in_manual_job_mapping_screen();
	}
	...
	public void validate_data_in_responsibilities_tab_in_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_data_in_responsibilities_tab_in_manual_job_mapping_screen();
	}
	...
	public void validate_data_in_behavioural_competencies_tab_in_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_data_in_behavioural_competencies_tab_in_manual_job_mapping_screen();
	}
	...
	public void validate_data_in_skills_tab_in_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_data_in_skills_tab_in_manual_job_mapping_screen();
	}
	...
	public void click_on_save_selection_button_in_manual_job_mapping_screen() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().click_on_save_selection_button_in_manual_job_mapping_screen();
	}
	...
	public void user_should_be_navigated_to_job_mapping_page() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_be_navigated_to_job_mapping_page();
	}
	...
	public void verify_organization_job_with_new_mapped_sp_is_displaying_on_top_of_profiles_list() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().verify_organization_job_with_new_mapped_sp_is_displaying_on_top_of_profiles_list();
	}
	...
	public void user_should_verify_profile_level_dropdown_is_available_in_details_popup_and_validate_levels_present_inside_dropdown() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().user_should_verify_profile_level_dropdown_is_available_in_details_popup_and_validate_levels_present_inside_dropdown();
	}
	...
	public void validate_profile_role_summary_in_details_popup_matches_with_mapped_success_profile_role_summary() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_profile_role_summary_in_details_popup_matches_with_mapped_success_profile_role_summary();
	}
	...
	public void validate_profile_details_in_details_popup_matches_with_mapped_success_profile_details() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_profile_details_in_details_popup_matches_with_mapped_success_profile_details();
	}
	...
	public void validate_profile_responsibilities_in_details_popup_matches_with_mapped_success_profile_responsibilities() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_profile_responsibilities_in_details_popup_matches_with_mapped_success_profile_responsibilities();
	}
	...
	public void validate_profile_behavioural_competencies_in_details_popup_matches_with_mapped_success_profile_behavioural_competencies() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_profile_behavioural_competencies_in_details_popup_matches_with_mapped_success_profile_behavioural_competencies();
	}
	...
	public void validate_profile_skills_in_details_popup_matches_with_mapped_success_profile_skills() throws IOException {
		mapDifferentSPtoProfileInAutoAI.getMapDifferentSPtoProfile().validate_profile_skills_in_details_popup_matches_with_mapped_success_profile_skills();
	}
