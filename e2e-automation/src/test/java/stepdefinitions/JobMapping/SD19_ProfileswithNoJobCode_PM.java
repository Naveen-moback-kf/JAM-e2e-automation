...
public class SD19_ProfileswithNoJobCode_PM {	
	...
	public void user_should_search_for_success_profile_with_no_job_code_assigned() throws IOException {
		PageObjectManager.getInstance().getProfileswithNoJobCode_PM().user_should_search_for_success_profile_with_no_job_code_assigned();
	}
	...
	public void user_should_verify_tooltip_is_displaying_on_checkbox_of_success_profile_with_no_job_code() throws IOException {
		PageObjectManager.getInstance().getProfileswithNoJobCode_PM().user_should_verify_tooltip_is_displaying_on_checkbox_of_success_profile_with_no_job_code();
	}
	...
	public void verify_details_of_the_success_profile_with_no_job_code_assigned_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getProfileswithNoJobCode_PM().verify_details_of_the_success_profile_with_no_job_code_assigned_in_hcm_sync_profiles_tab();
	}
