...
public class SD13_AddandVerifyCustomSPinJobComparisonPage {
	PageObjectManager addandVerifyCustomSPinJobComparisonPage = new PageObjectManager();
	
	public SD13_AddandVerifyCustomSPinJobComparisonPage() {
		super();		
	}
	
	@Then("Click on Search bar in Job Comparison Page")
	public void click_on_search_bar_in_job_comparison_page() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().click_on_search_bar_in_job_comparison_page();
	}
	...
	public void verify_search_bar_placeholder_text_in_job_comparison_page() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_search_bar_placeholder_text_in_job_comparison_page();
	}
	...
	public void user_should_enter_custom_sp_search_string_in_the_search_bar() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().user_should_enter_custom_sp_search_string_in_the_search_bar();
	}

	@Then("Select first Custom SP from search results")
	public void select_first_custom_sp_from_search_results() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().select_first_custom_sp_from_search_results();
	}
	...
	public void verify_custom_sp_added_to_profiles_list_in_job_comparison_page() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_added_to_profiles_list_in_job_comparison_page();
	}
	...
	public void user_should_verify_custom_sp_name_and_close_button_are_displaying_in_search_bar_after_adding_custom_sp() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().user_should_verify_custom_sp_name_and_close_button_are_displaying_in_search_bar_after_adding_custom_sp();
	}
	...
	public void user_added_custom_sp_to_profiles_list_in_job_comparison_page() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().user_added_custom_sp_to_profiles_list_in_job_comparison_page();
	}
	...
	public void validate_custom_sp_profile_name_matches_with_selected_custom_sp_name_from_search_results() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().validate_custom_sp_profile_name_matches_with_selected_custom_sp_name_from_search_results();
	}
	...
	public void user_should_verify_close_button_and_select_button_are_displaying_on_the_profile() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().user_should_verify_close_button_and_select_button_are_displaying_on_the_profile();
	}

	@Then("Verify Custom SP Profile Grade")
	public void verify_custom_sp_profile_grade() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_grade();
	}

	@Then("Verify Custom SP Profile Level Sublevels")
	public void verify_custom_sp_profile_level_sublevels() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_level_sublevels();
	}
	...
	public void verify_custom_sp_profile_function_subfunction() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_function_subfunction();
	}

	@Then("Verify Custom SP Profile Seniority level")
	public void verify_custom_sp_profile_seniority_level() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_seniority_level();
	}
	...
	public void verify_custom_sp_profile_managerial_experience() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_managerial_experience();
	}

	@Then("Verify Custom SP Profile Education")
	public void verify_custom_sp_profile_education() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_education();
	}
	...
	public void verify_custom_sp_profile_general_experience() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_general_experience();
	}

	@Then("Verify Custom SP Profile Role Summary")
	public void verify_custom_sp_profile_role_summary() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_role_summary();
	}

	@Then("Verify Custom SP Profile Responsibilities")
	public void verify_custom_sp_profile_responsibilities() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_responsibilities();
	}
	...
	public void verify_custom_sp_profile_behavioural_competencies() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_behavioural_competencies();
	}

	@Then("Verify Custom SP Profile Skills")
	public void verify_custom_sp_profile_skills() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_custom_sp_profile_skills();
	}
	...
	public void clear_text_in_search_bar_with_clear_button_in_the_search_bar() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().clear_text_in_search_bar_with_clear_button_in_the_search_bar();
	}
	...
	public void user_should_verify_added_custom_sp_is_not_cleared_from_profiles_list_in_job_comparison_page() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().user_should_verify_added_custom_sp_is_not_cleared_from_profiles_list_in_job_comparison_page();
	}


	@Then("Select Third Custom SP from search results")
	public void select_third_custom_sp_from_search_results() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().select_third_custom_sp_from_search_results();
	}
	...
	public void verify_new_custom_sp_replaces_existing_custom_sp_in_profiles_list_in_job_comparison_page() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().verify_new_custom_sp_replaces_existing_custom_sp_in_profiles_list_in_job_comparison_page();
	}
	...
	public void clear_custom_sp_and_text_in_search_bar_with_close_button_on_the_profile() throws IOException {
		addandVerifyCustomSPinJobComparisonPage.getAddandVerifyCustomSPinJobComparisonPage().clear_custom_sp_and_text_in_search_bar_with_close_button_on_the_profile();
	}
}
