...
public class SD32_ClearProfileSelectionFunctionality extends DriverManager {	
	...
	public void click_on_header_checkbox_to_select_loaded_job_profiles(String screen) throws Exception {
		PageObjectManager.getInstance().getClearProfileSelectionFunctionality()
	...
	public void click_on_none_button(String screen) throws Exception {
		PageObjectManager.getInstance().getClearProfileSelectionFunctionality().click_on_none_button(screen);
	}
	...
	public void refresh_screen(String screen) throws Exception {
		PageObjectManager.getInstance().getClearProfileSelectionFunctionality().refresh_screen(screen);
	}
	...
	public void verify_action_button_is_enabled(String screen) throws Exception {
		PageObjectManager.getInstance().getClearProfileSelectionFunctionality().verify_action_button_is_enabled(screen);
	}
	...
	public void verify_action_button_is_disabled(String screen) throws Exception {
		PageObjectManager.getInstance().getClearProfileSelectionFunctionality().verify_action_button_is_disabled(screen);
	}
}
