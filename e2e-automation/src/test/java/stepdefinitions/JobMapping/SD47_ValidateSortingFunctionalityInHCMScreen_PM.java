...
public class SD47_ValidateSortingFunctionalityInHCMScreen_PM {
	...
	@Then("Sort Profiles by Last Modified in Ascending order in HCM Sync Profiles screen")
	public void sort_profiles_by_last_modified_in_ascending_order_in_hcm_sync_profiles_screen() throws IOException {
		validateSortingFunctionalityInHCMScreen_PM.getValidateSortingFunctionalityInHCMScreen_PM().sort_profiles_by_last_modified_in_ascending_order_in_hcm_sync_profiles_screen();
	}
	...
	@Then("User should verify first hundred job profiles are correctly sorted by Last Modified in Ascending and Function in Descending order")
	public void user_should_verify_first_hundred_job_profiles_are_correctly_sorted_by_last_modified_in_ascending_and_function_in_descending_order() throws IOException {
		validateSortingFunctionalityInHCMScreen_PM.getValidateSortingFunctionalityInHCMScreen_PM().user_should_verify_first_hundred_job_profiles_are_correctly_sorted_by_last_modified_in_ascending_and_function_in_descending_order();
	}
	...
	@Then("User should verify first hundred job profiles are correctly sorted by Last Modified Ascending, Export Status Descending and Function Ascending")
	public void user_should_verify_first_hundred_job_profiles_are_correctly_sorted_by_last_modified_ascending_export_status_descending_and_function_ascending() throws IOException {
		validateSortingFunctionalityInHCMScreen_PM.getValidateSortingFunctionalityInHCMScreen_PM().user_should_verify_first_hundred_job_profiles_are_correctly_sorted_by_last_modified_ascending_export_status_descending_and_function_ascending();
	}
