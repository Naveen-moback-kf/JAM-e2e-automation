...
public class SD11_ProfileLevelFunctionality {	
	...
	public void change_profile_level() throws IOException {
		PageObjectManager.getInstance().getProfileLevelFunctionality().change_profile_level();
	}
	...
	public void change_profile_level_in_job_comparison_page() throws IOException {
		PageObjectManager.getInstance().getProfileLevelFunctionality().change_profile_level_in_job_comparison_page();
	}
	...
	public void user_should_verify_profile_header_matches_with_changed_profile_level_in_job_profile_details_popup() throws IOException {
		PageObjectManager.getInstance().getProfileLevelFunctionality().user_should_verify_profile_header_matches_with_changed_profile_level_in_job_profile_details_popup();
	}
	...
	public void user_should_verify_recommended_profile_name_matches_with_changed_profile_level() throws IOException {
		PageObjectManager.getInstance().getProfileLevelFunctionality(). user_should_verify_recommended_profile_name_matches_with_changed_profile_level();
	}
	...
	public void user_is_in_job_comparison_page_after_changing_profile_level() throws IOException {
		PageObjectManager.getInstance().getProfileLevelFunctionality().user_is_in_job_comparison_page_after_changing_profile_level();
	}
