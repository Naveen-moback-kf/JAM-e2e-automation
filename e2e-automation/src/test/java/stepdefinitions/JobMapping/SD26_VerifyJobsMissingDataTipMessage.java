...
public class SD26_VerifyJobsMissingDataTipMessage extends DriverManager {
	PageObjectManager verifyJobsMissingDataTipMessage = new PageObjectManager();
	
	public SD26_VerifyJobsMissingDataTipMessage() {
		super();		
	}
	...
	public void verify_missing_data_tip_message_is_displaying_on_job_mapping_page() throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().verify_missing_data_tip_message_is_displaying_on_job_mapping_page();
	}
	...
	public void verify_missing_data_tip_message_contains_correct_count_of_jobs_with_missing_data() throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().verify_missing_data_tip_message_contains_correct_count_of_jobs_with_missing_data();
	}
	...
	public void verify_missing_data_tip_message_contains_text_about_jobs_having_missing_data() throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().verify_missing_data_tip_message_contains_text_about_jobs_having_missing_data();
	}
	...
	public void verify_missing_data_tip_message_contains_text_about_reduced_match_accuracy() throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().verify_missing_data_tip_message_contains_text_about_reduced_match_accuracy();
	}
	...
	public void verify_link_is_present_in_missing_data_tip_message(String linkText) throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().verify_link_is_present_in_missing_data_tip_message(linkText);
	}
	...
	public void click_on_link_in_missing_data_tip_message(String linkText) throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().click_on_link_in_missing_data_tip_message(linkText);
	}
	...
	public void verify_user_is_navigated_to_appropriate_page_for_viewing_and_re_uploading_jobs() throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().verify_user_is_navigated_to_appropriate_page_for_viewing_and_re_uploading_jobs();
	}

	@Then("Navigate back to Job Mapping page")
	public void navigate_back_to_job_mapping_page() throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().navigate_back_to_job_mapping_page();
	}
	...
	public void verify_missing_data_tip_message_is_still_displaying_on_job_mapping_page() throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().verify_missing_data_tip_message_is_still_displaying_on_job_mapping_page();
	}
	...
	public void click_on_close_button_in_missing_data_tip_message() throws IOException {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().click_on_close_button_in_missing_data_tip_message();
	}
	...
	public void verify_missing_data_tip_message_is_no_longer_displayed_on_job_mapping_page() throws Exception {
		verifyJobsMissingDataTipMessage.getVerifyJobsMissingDataTipMessage().verify_missing_data_tip_message_is_no_longer_displayed_on_job_mapping_page();
	}
