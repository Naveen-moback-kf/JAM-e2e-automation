...
public class SD36_DeleteJobProfiles {
	...
	PageObjectManager deleteJobProfiles = new PageObjectManager();
	...
	public void user_should_verify_delete_button_is_disabled() throws IOException {
		deleteJobProfiles.getDeleteJobProfiles().user_should_verify_delete_button_is_disabled();
	}
	...
	public void user_should_verify_delete_button_is_enabled() throws IOException {
		deleteJobProfiles.getDeleteJobProfiles().user_should_verify_delete_button_is_enabled();
	}
	
	@Then("Click on Delete button in Job Mapping")
	public void click_on_delete_button_in_job_mapping() throws IOException {
		deleteJobProfiles.getDeleteJobProfiles().click_on_delete_button_in_job_mapping();
	}
	...
	public void verify_delete_confirmation_popup_is_displayed() throws IOException {
		deleteJobProfiles.getDeleteJobProfiles().verify_delete_confirmation_popup_is_displayed();
	}
	...
	public void click_on_cancel_button_on_delete_confirmation_popup() throws IOException {
		deleteJobProfiles.getDeleteJobProfiles().click_on_cancel_button_on_delete_confirmation_popup();
	}
	...
	public void click_on_delete_button_on_delete_confirmation_popup() throws IOException {
		deleteJobProfiles.getDeleteJobProfiles().click_on_delete_button_on_delete_confirmation_popup();
	}
	...
	public void user_should_verify_delete_success_popup_appears_on_screen() throws IOException {
		deleteJobProfiles.getDeleteJobProfiles().user_should_verify_delete_success_popup_appears_on_screen();
	}
