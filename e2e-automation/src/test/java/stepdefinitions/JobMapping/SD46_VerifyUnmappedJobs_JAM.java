...
public class SD46_VerifyUnmappedJobs_JAM {
	PageObjectManager verifyUnmappedJobs_JAM = new PageObjectManager();
	
	public SD46_VerifyUnmappedJobs_JAM() {
		super();		
	}
	...
	public void select_unmapped_jobs_option_in_mapping_status_filters_dropdown() throws IOException {
		verifyUnmappedJobs_JAM.getVerifyUnmappedJobs_JAM().select_unmapped_jobs_option_in_mapping_status_filters_dropdown();
	}
	...
	public void verify_header_checkbox_is_disabled_in_job_mapping_screen() throws IOException {
		verifyUnmappedJobs_JAM.getVerifyUnmappedJobs_JAM().verify_header_checkbox_is_disabled_in_job_mapping_screen();
	}
	...
	public void verify_chevron_button_is_disabled_in_job_mapping_screen() throws IOException {
		verifyUnmappedJobs_JAM.getVerifyUnmappedJobs_JAM().verify_chevron_button_is_disabled_in_job_mapping_screen();
	}
	...
	public void verify_checkbox_of_all_unmapped_jobs_is_disabled_with_tooltip() throws IOException {
		verifyUnmappedJobs_JAM.getVerifyUnmappedJobs_JAM().verify_checkbox_of_all_unmapped_jobs_is_disabled_with_tooltip();
	}
