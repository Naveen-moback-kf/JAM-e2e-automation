...
public class SD25_MissingDataFunctionality extends DriverManager {
	...
	public void sort_job_profiles_by_column_in_ascending_order(String sortColumn) throws IOException {
		pageObjectManager.getMissingDataFunctionality().sort_job_profiles_by_column_in_ascending_order(sortColumn);
	}
	...
	public void find_job_profile_in_job_mapping_page_where_data_is_missing(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().find_job_profile_in_job_mapping_page_where_data_is_missing(dataType);
	}
	...
	public void extract_job_details_from_found_profile_in_job_mapping_page(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().extract_job_details_from_found_profile_in_job_mapping_page(dataType);
	}
	...
	public void verify_user_is_navigated_to_jobs_with_missing_data_screen(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().verify_user_is_navigated_to_jobs_with_missing_data_screen(dataType);
	}
	...
	public void search_for_extracted_job_profile_in_jobs_missing_data_screen(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().search_for_extracted_job_profile_in_jobs_missing_data_screen(dataType);
	}
	...
	public void verify_job_profile_found_in_missing_data_screen_search_results(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().verify_job_profile_found_in_jobs_missing_data_screen_search_results(dataType);
	}
	...
	public void extract_job_details_from_found_profile_in_jobs_missing_data_screen(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().extract_job_details_from_found_profile_in_jobs_missing_data_screen(dataType);
	}
	...
	public void verify_job_details_match_between_job_mapping_and_missing_data_screen(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().verify_all_job_details_match_forward_flow(dataType);
	}
	...
	public void click_close_button_to_return_to_job_mapping_page(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().click_on_close_button_to_return_to_job_mapping_page(dataType);
	}
	...
	public void verify_user_is_back_on_job_mapping_page(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().verify_user_is_back_on_job_mapping_page(dataType);
	}
	...
	public void find_job_in_jobs_missing_data_screen_where_data_is_na(String screenType, String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().find_job_in_jobs_missing_data_screen_where_data_is_na(dataType);
	}
	...
	public void extract_all_job_details_from_jobs_with_missing_data_screen(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().extract_all_available_job_details_from_jobs_with_missing_data_screen(dataType);
	}
	...
	public void search_for_extracted_job_profile_in_job_mapping_page(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().search_for_extracted_job_profile_in_job_mapping_page(dataType);
	}
	...
	public void verify_job_profile_is_found_in_search_results(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().verify_job_profile_found_in_job_mapping_page_search_results(dataType);
	}
	...
	public void extract_job_details_from_searched_profile_in_job_mapping_page(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().extract_job_details_from_searched_profile_in_job_mapping_page(dataType);
	}
	...
	public void verify_job_details_match_between_missing_data_and_job_mapping(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().verify_all_job_details_match_reverse_flow(dataType);
	}
	...
	public void verify_info_message_is_displayed_indicating_missing_data(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().verify_info_message_is_displayed_indicating_missing_data(dataType);
	}
	...
	public void verify_info_message_contains_reduced_accuracy_text(String dataType) throws IOException {
		pageObjectManager.getMissingDataFunctionality().verify_info_message_contains_reduced_accuracy_text(dataType);
	}
}
