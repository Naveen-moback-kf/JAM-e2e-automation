...
public class SD24_InfoMessageManualMappingProfiles extends DriverManager {	
	...
	public void user_is_in_job_mapping_page_with_manual_mapping_filters_applied() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().user_is_in_job_mapping_page_with_manual_mapping_filters_applied();
	}
	...
	public void find_and_verify_manually_mapped_profile_with_missing_data_has_info_message_displayed() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().find_and_verify_manually_mapped_profile_with_missing_data_has_info_message_displayed();
	}
	...
	public void verify_info_message_contains_text_about_reduced_match_accuracy_due_to_missing_data_for_manual_mapping() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().verify_info_message_contains_text_about_reduced_match_accuracy_due_to_missing_data_for_manual_mapping();
	}
	...
	public void find_and_verify_second_manually_mapped_profile_with_missing_data_has_info_message_displayed() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().find_and_verify_second_manually_mapped_profile_with_missing_data_has_info_message_displayed();
	}
	...
	public void verify_info_message_contains_text_about_reduced_match_accuracy_due_to_missing_data_for_second_manually_mapped_profile() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().verify_info_message_contains_text_about_reduced_match_accuracy_due_to_missing_data_for_second_manually_mapped_profile();
	}
	...
	public void find_manually_mapped_profile_with_missing_data_and_info_message() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().find_manually_mapped_profile_with_missing_data_and_info_message();
	}
	...
	public void find_second_manually_mapped_profile_with_missing_data_and_info_message() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().find_second_manually_mapped_profile_with_missing_data_and_info_message();
	}
	...
	public void extract_job_details_from_manually_mapped_profile_with_info_message() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().extract_job_details_from_manually_mapped_profile_with_info_message();
	}
	...
	public void extract_job_details_from_manual_mapping_page() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().extract_job_details_from_manual_mapping_page();
	}
	...
	public void verify_job_details_match_between_job_mapping_and_manual_mapping_pages() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().verify_job_details_match_between_job_mapping_and_manual_mapping_pages();
	}
	...
	public void extract_job_details_from_second_manually_mapped_profile_with_info_message() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().extract_job_details_from_second_manually_mapped_profile_with_info_message();
	}
	...
	public void extract_job_details_from_manual_mapping_page_for_second_manually_mapped_profile() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().extract_job_details_from_manual_mapping_page_for_second_manually_mapped_profile();
	}
	...
	public void verify_job_details_match_between_job_mapping_and_manual_mapping_pages_for_second_manually_mapped_profile() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().verify_job_details_match_between_job_mapping_and_manual_mapping_pages_for_second_manually_mapped_profile();
	}
	...
	public void click_on_button_for_manually_mapped_profile_with_info_message(String buttonText) throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().click_on_button_for_manually_mapped_profile_with_info_message(buttonText);
	}
	...
	public void click_on_button_for_second_manually_mapped_profile_with_info_message(String buttonText) throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().click_on_button_for_second_manually_mapped_profile_with_info_message(buttonText);
	}
	...
	public void verify_user_is_navigated_to_manual_mapping_page() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().verify_user_is_navigated_to_manual_mapping_page();
	}
	...
	public void verify_info_message_is_still_displayed_in_manual_mapping_page() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().verify_info_message_is_still_displayed_in_manual_mapping_page();
	}
	...
	public void verify_info_message_contains_same_text_about_reduced_match_accuracy_for_manual_mapping() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().verify_info_message_contains_same_text_about_reduced_match_accuracy_for_manual_mapping();
	}
	...
	public void verify_info_message_is_still_displayed_in_manual_mapping_page_for_second_manually_mapped_profile() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().verify_info_message_is_still_displayed_in_manual_mapping_page_for_second_manually_mapped_profile();
	}
	...
	public void verify_info_message_contains_same_text_about_reduced_match_accuracy_for_second_manually_mapped_profile() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().verify_info_message_contains_same_text_about_reduced_match_accuracy_for_second_manually_mapped_profile();
	}
	...
	public void navigate_back_to_job_mapping_page_from_manual_mapping() throws IOException {
		PageObjectManager.getInstance().getInfoMessageManualMappingProfiles().navigate_back_to_job_mapping_page_from_manual_mapping();
	}
