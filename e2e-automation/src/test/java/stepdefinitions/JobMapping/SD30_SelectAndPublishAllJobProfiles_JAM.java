...
public class SD30_SelectAndPublishAllJobProfiles_JAM {
	...
	public void verify_count_of_total_un_published_profiles_before_publishing_selected_profiles() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().verify_count_of_total_un_published_profiles_before_publishing_selected_profiles();
	}
	...
	public void verify_count_of_total_published_profiles_before_publishing_selected_profiles() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().verify_count_of_total_published_profiles_before_publishing_selected_profiles();
	}
	...
	public void click_on_view_published_toggle_button_to_turn_off() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().click_on_view_published_toggle_button_to_turn_off();
	}
	...
	public void click_on_chevron_button_beside_header_checkbox_in_job_mapping_screen() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().click_on_chevron_button_beside_header_checkbox_in_job_mapping_screen();
	}
	...
	public void click_on_select_all_button_in_job_mapping_screen() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().click_on_select_all_button_in_job_mapping_screen();
	}
	...
	public void refresh_job_mapping_page_after_specified_time_in_message() throws IOException, InterruptedException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().refresh_job_mapping_page_after_specified_time_in_message();
	}
	...
	public void verify_count_of_total_un_published_profiles_after_publishing_selected_profiles() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().verify_count_of_total_un_published_profiles_after_publishing_selected_profiles();
	}
	...
	public void get_count_of_published_profiles_in_job_mapping_screen() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().get_count_of_published_profiles_in_job_mapping_screen();
	}
	...
	public void verify_count_of_total_published_profiles_after_publishing_selected_profiles() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().verify_count_of_total_published_profiles_after_publishing_selected_profiles();
	}
	...
	public void verify_published_profiles_count_matches_in_view_published_screen() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().verify_published_profiles_count_matches_in_view_published_screen();
	}
	...
	public void user_is_in_job_mapping_page_after_initial_refresh() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().user_is_in_job_mapping_page_after_initial_refresh();
	}
	...
	public void calculate_expected_total_time_for_batch_publishing_based_on_profile_count() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().calculate_expected_total_time_for_batch_publishing_based_on_profile_count();
	}
	...
	public void monitor_and_validate_progressive_batch_publishing_until_completion() throws IOException, InterruptedException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().monitor_and_validate_progressive_batch_publishing_until_completion();
	}
	...
	public void verify_all_profiles_are_published_successfully() throws IOException {
		validateSelectAndPublishAllJobProfilesinJAM.getSelectAndPublishAllJobProfiles_JAM().verify_all_profiles_are_published_successfully();
	}
