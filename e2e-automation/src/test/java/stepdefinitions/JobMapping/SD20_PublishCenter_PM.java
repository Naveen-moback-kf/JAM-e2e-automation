...
public class SD20_PublishCenter_PM {
	...
	public void user_is_in_hcm_sync_profiles_screen_after_syncing_profiles() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().user_is_in_hcm_sync_profiles_screen_after_syncing_profiles();
	}
	
	@Then("Click on Publish Center button")
	public void click_on_publish_center_button() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().click_on_publish_center_button();
	}
	...
	public void verify_user_navigated_to_job_profile_history_screen_succcessfully() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().verify_user_navigated_to_job_profile_history_screen_succcessfully();
	}
	...
	public void verify_recently_downloaded_job_profiles_history_is_in_top_row() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().verify_recently_downloaded_job_profiles_history_is_in_top_row();
	}
	...
	public void verify_details_of_the_recently_downloaded_job_profiles_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().verify_details_of_the_recently_downloaded_job_profiles_in_job_profile_history_screen();
	}
	...
	public void click_on_profiles_count_of_recently_downloaded_job_profiles_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().click_on_profiles_count_of_recently_downloaded_job_profiles_in_job_profile_history_screen();
	}
	...
	public void user_should_be_navigated_to_profiles_downloaded_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().user_should_be_navigated_to_profiles_downloaded_screen();
	}
	...
	public void verify_details_in_profiles_downloaded_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().verify_details_in_profiles_downloaded_screen();
	}

	@Then("Close Profiles Downloaded screen")
	public void close_profiles_downloaded_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().close_profiles_downloaded_screen();
	}
	...
	public void select_job_profiles_in_hcm_sync_profiles_tab() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().select_job_profiles_in_hcm_sync_profiles_tab();
	}
	...
	public void verify_recently_exported_job_profiles_history_is_in_top_row() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().verify_recently_exported_job_profiles_history_is_in_top_row();
	}
	...
	public void verify_details_of_the_recently_exported_job_profiles_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().verify_details_of_the_recently_exported_job_profiles_in_job_profile_history_screen();
	}
	...
	public void click_on_profiles_count_of_recently_exported_job_profiles_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().click_on_profiles_count_of_recently_exported_job_profiles_in_job_profile_history_screen();
	}
	...
	public void user_should_be_navigated_to_profiles_exported_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().user_should_be_navigated_to_profiles_exported_screen();
	}

	@Then("Verify details in Profiles Exported screen")
	public void verify_details_in_profiles_exported_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().verify_details_in_profiles_exported_screen();
	}

	@Then("Close Profiles Exported screen")
	public void close_profiles_exported_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().close_profiles_exported_screen();
	}
	
	@When("User is in Job Profile History screen")
	public void user_is_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().user_is_in_job_profile_history_screen();
	}
	...
	public void sort_job_profiles_by_no_of_profiles_in_ascending_order_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().sort_job_profiles_by_no_of_profiles_in_ascending_order_in_job_profile_history_screen();
	}
	...
	public void user_should_verify_first_thirty_job_profiles_sorted_by_no_of_profiles_in_ascending_order_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().user_should_verify_first_thirty_job_profiles_sorted_by_no_of_profiles_in_ascending_order_in_job_profile_history_screen();
	}
	...
	public void user_should_refresh_job_profile_history_screen_and_verify_job_profiles_are_in_default_order() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().user_should_refresh_job_profile_history_screen_and_verify_job_profiles_are_in_default_order();
	}
	...
	public void sort_job_profiles_by_no_of_profiles_in_descending_order_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().sort_job_profiles_by_no_of_profiles_in_descending_order_in_job_profile_history_screen();
	}
	...
	public void user_should_verify_first_thirty_job_profiles_sorted_by_no_of_profiles_in_descending_order_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().user_should_verify_first_thirty_job_profiles_sorted_by_no_of_profiles_in_descending_order_in_job_profile_history_screen();
	}
	...
	public void sort_job_profiles_by_accessed_date_in_ascending_order_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().sort_job_profiles_by_accessed_date_in_ascending_order_in_job_profile_history_screen();
	}
	...
	public void user_should_verify_first_thirty_job_profiles_sorted_by_accessed_date_in_ascending_order_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().user_should_verify_first_thirty_job_profiles_sorted_by_accessed_date_in_ascending_order_in_job_profile_history_screen();
	}
	...
	public void sort_job_profiles_by_accessed_date_in_descending_order_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().sort_job_profiles_by_accessed_date_in_descending_order_in_job_profile_history_screen();
	}
	...
	public void user_should_verify_first_thirty_job_profiles_sorted_by_accessed_date_in_descending_order_in_job_profile_history_screen() throws IOException {
		ValidatePublishCenter_PM.getPublishCenter_PM().user_should_verify_first_thirty_job_profiles_sorted_by_accessed_date_in_descending_order_in_job_profile_history_screen();
	}
