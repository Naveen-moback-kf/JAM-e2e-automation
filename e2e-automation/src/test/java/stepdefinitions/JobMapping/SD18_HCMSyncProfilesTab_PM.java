...
public class SD18_HCMSyncProfilesTab_PM {	
	...
	public void user_should_be_navigated_to_hcm_sync_profiles_screen() throws Exception {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_should_be_navigated_to_hcm_sync_profiles_screen();
	}
	...
	public void verify_title_is_correctly_displaying_in_hcm_sync_profiles_tab() throws Exception {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().verify_title_is_correctly_displaying_in_hcm_sync_profiles_tab();
	}
	...
	public void verify_description_below_the_title_is_correctly_displaying_in_hcm_sync_profiles_tab() throws Exception {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().verify_description_below_the_title_is_correctly_displaying_in_hcm_sync_profiles_tab();
	}
	...
	public void verify_search_bar_text_box_is_clickable_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().verify_search_bar_text_box_is_clickable_in_hcm_sync_profiles_tab();
	}
	...
	public void verify_search_bar_placeholder_text_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().verify_search_bar_placeholder_text_in_hcm_sync_profiles_tab();
	}
	...
	public void enter_job_profile_name_in_search_bar_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().enter_job_profile_name_in_search_bar_in_hcm_sync_profiles_tab();
	}
	...
	public void user_should_verify_profile_name_matching_profile_is_displaying_in_organization_jobs_profile_list() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_should_verify_profile_name_matching_profile_is_displaying_in_organization_jobs_profile_list();
	}
	...
	public void click_on_name_matching_profile_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().click_on_name_matching_profile_in_hcm_sync_profiles_tab();
	}
	...
	public void user_should_be_navigated_to_sp_details_page_on_click_of_matching_profile() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_should_be_navigated_to_sp_details_page_on_click_of_matching_profile();
	}
	...
	public void clear_search_bar_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().clear_search_bar_in_hcm_sync_profiles_tab();
	}
	...
	public void verify_job_profiles_count_is_displaying_on_the_page_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().verify_job_profiles_count_is_displaying_on_the_page_in_hcm_sync_profiles_tab();
	}
	...
	public void scroll_page_to_view_more_job_profiles_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().scroll_page_to_view_more_job_profiles_in_hcm_sync_profiles_tab();
	}
	...
	public void user_should_verify_count_of_job_profiles_is_correctly_showing_on_top_of_job_profiles_listing_table_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_should_verify_count_of_job_profiles_is_correctly_showing_on_top_of_job_profiles_listing_table_in_hcm_sync_profiles_tab();
	}

	@When("User is in HCM Sync Profiles screen")
	public void user_is_in_hcm_sync_profiles_screen() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_is_in_hcm_sync_profiles_screen();
	}
	...
	public void click_on_filters_dropdown_button_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().click_on_filters_dropdown_button_in_hcm_sync_profiles_tab();
	}
	...
	public void verify_options_available_inside_filters_dropdown_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().verify_options_available_inside_filters_dropdown_in_hcm_sync_profiles_tab();
	}
	...
	public void apply_kf_grade_filter_and_verify_profiles_count_is_correctly_displaying_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().apply_kf_grade_filter_and_verify_profiles_count_is_correctly_displaying_in_hcm_sync_profiles_tab();
	}
	...
	public void clear_kf_grade_filter_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().clear_kf_grade_filter_in_hcm_sync_profiles_tab();
	}
	...
	public void apply_levels_filter_and_verify_profiles_count_is_correctly_displaying_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().apply_levels_filter_and_verify_profiles_count_is_correctly_displaying_in_hcm_sync_profiles_tab();
	}
	...
	public void apply_different_levels_filter_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().apply_different_levels_filter_in_hcm_sync_profiles_tab();
	}
	...
	public void clear_levels_filter_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().clear_levels_filter_in_hcm_sync_profiles_tab();
	}
	...
	public void apply_functions_or_subfunctions_filter_and_verify_profiles_count_is_correctly_displaying_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().apply_functions_or_subfunctions_filter_and_verify_profiles_count_is_correctly_displaying_in_hcm_sync_profiles_tab();
	}
	...
	public void click_on_clear_all_filters_button_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().click_on_clear_all_filters_button_in_hcm_sync_profiles_tab();
	}
	...
	public void apply_profile_status_filter_and_verify_profiles_count_is_correctly_displaying_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().apply_profile_status_filter_and_verify_profiles_count_is_correctly_displaying_in_hcm_sync_profiles_tab();
	}
	...
	public void user_should_verify_organization_jobs_table_headers_are_correctly_displaying_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_should_verify_organization_jobs_table_headers_are_correctly_displaying_in_hcm_sync_profiles_tab();
	}
	...
	public void click_on_header_checkbox_to_select_loaded_job_profiles_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().click_on_header_checkbox_to_select_loaded_job_profiles_in_hcm_sync_profiles_tab();
	}
	...
	public void user_should_uncheck_header_checkbox_to_deselect_selected_job_profiles_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_should_uncheck_header_checkbox_to_deselect_selected_job_profiles_in_hcm_sync_profiles_tab();
	}
	...
	public void click_on_first_profile_checkbox_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().click_on_first_profile_checkbox_in_hcm_sync_profiles_tab();
	}
	...
	public void click_on_second_profile_checkbox_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().click_on_second_profile_checkbox_in_hcm_sync_profiles_tab();
	}
	...
	public void click_on_third_profile_checkbox_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().click_on_third_profile_checkbox_in_hcm_sync_profiles_tab();
	}
	...
	public void user_should_verify_sync_with_hcm_button_is_disabled_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_should_verify_sync_with_hcm_button_is_disabled_in_hcm_sync_profiles_tab();
	}
	...
	public void user_should_verify_sync_with_hcm_button_is_enabled_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_should_verify_sync_with_hcm_button_is_enabled_in_hcm_sync_profiles_tab();
	}
	...
	public void verify_checkboxes_of_first_second_and_third_profile_are_selected_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().verify_checkboxes_of_first_second_and_third_profile_are_selected_in_hcm_sync_profiles_tab();
	}
	...
	public void click_on_sync_with_hcm_button_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().click_on_sync_with_hcm_button_in_hcm_sync_profiles_tab();
	}
	...
	public void user_should_verify_sync_with_hcm_success_popup_appears_on_screen_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().user_should_verify_sync_with_hcm_success_popup_appears_on_screen_in_hcm_sync_profiles_tab();
	}
	...
	public void verify_checkboxes_of_first_second_and_third_profile_are_deselected_in_hcm_sync_profiles_tab() throws IOException {
		PageObjectManager.getInstance().getHCMSyncProfilesTab_PM().verify_checkboxes_of_first_second_and_third_profile_are_deselected_in_hcm_sync_profiles_tab();
	}
