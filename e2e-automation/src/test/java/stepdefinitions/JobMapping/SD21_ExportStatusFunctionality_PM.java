...
public class SD21_ExportStatusFunctionality_PM {
	...
	public void user_should_search_for_a_profile_with_export_status_as_not_exported() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().user_should_search_for_a_profile_with_export_status_as_not_exported();
	}
	...
	public void verify_details_of_the_not_exported_success_profile_in_hcm_sync_profiles_tab() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().verify_details_of_the_not_exported_success_profile_in_hcm_sync_profiles_tab();
	}
	...
	public void verify_success_profile_checkbox_is_enabled_and_able_to_perform_export_operation() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().verify_success_profile_checkbox_is_enabled_and_able_to_perform_export_operation();
	}
	...
	public void click_on_checkbox_of_success_profile_with_export_status_as_not_exported() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().click_on_checkbox_of_success_profile_with_export_status_as_not_exported();
	}

	@Then("Refresh HCM Sync Profiles screen")
	public void refresh_hcm_sync_profiles_tab() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().refresh_hcm_sync_profiles_tab();
	}
	...
	public void user_should_verify_export_status_of_sp_updated_as_exported() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().user_should_verify_export_status_of_sp_updated_as_exported();
	}
	...
	public void user_should_click_on_recently_exported_success_profile_job_name() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().user_should_click_on_recently_exported_success_profile_job_name();
	}
	...
	public void user_should_be_navigated_to_sp_details_page() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().user_should_be_navigated_to_sp_details_page();
	}
	
	@Then("Click on three dots in SP details page")
	public void click_on_three_dots_in_sp_details_page() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().click_on_three_dots_in_sp_details_page();
	}

	@Then("Click on Edit Success Profile option")
	public void click_on_edit_success_profile_option() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().click_on_edit_success_profile_option();
	}

	@Then("Click on Edit button of Details section")
	public void click_on_edit_button_of_details_section() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().click_on_edit_button_of_details_section();
	}
	...
	public void modify_function_and_sub_function_values_of_the_success_profile() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().modify_function_and_sub_function_values_of_the_success_profile();
	}

	@Then("Click on Done button")
	public void click_on_done_button() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().click_on_done_button();
	}

	@Then("Click on Save button")
	public void click_on_save_button() throws IOException {
		ValidateExportStatusFunctionality_PM.getExportStatusFunctionality_PM().click_on_save_button();
	}
