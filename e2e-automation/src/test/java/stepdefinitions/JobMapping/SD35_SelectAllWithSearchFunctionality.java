...
/**
 * Consolidated Step Definitions for Select All / Loaded Profiles Selection with Search functionality.
 * Supports both PM (HCM Sync Profiles) and JAM (Job Mapping) screens.
 */
public class SD35_SelectAllWithSearchFunctionality extends DriverManager {

	private PageObjectManager pageObjectManager = new PageObjectManager();

	public SD35_SelectAllWithSearchFunctionality() {
		super();
	}
	...
	public void user_should_scroll_down_to_view_last_search_result(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().user_should_scroll_down_to_view_last_search_result(screen);
	}
	...
	public void user_should_validate_all_search_results_contains_substring(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().user_should_validate_all_search_results_contains_substring(screen);
	}
	...
	public void click_on_chevron_button_beside_header_checkbox(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().click_on_chevron_button_beside_header_checkbox(screen);
	}

	@Then("Click on Select All button in {string} screen")
	public void click_on_select_all_button(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().click_on_select_all_button(screen);
	}
	...
	public void select_loaded_job_profiles_using_header_checkbox(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().click_on_header_checkbox_to_select_loaded_profiles(screen);
	}
	...
	public void verify_action_button_is_enabled_after_search_selection(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().verify_action_button_is_enabled(screen);
	}
	...
	public void scroll_to_load_more_profiles(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().scroll_page_to_view_more_job_profiles(screen);
	}
	...
	public void verify_newly_loaded_profiles_after_header_checkbox_are_not_selected(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().verify_profiles_loaded_after_header_checkbox_are_not_selected(screen);
	}
	...
	public void capture_baseline_of_selected_profiles(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().capture_baseline_of_selected_profiles(screen);
	}

	@Then("Clear Search bar in {string} screen")
	public void clear_search_bar(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().clear_search_bar(screen);
	}
	...
	public void verify_only_searched_profiles_are_selected_after_clearing_search_bar(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().verify_only_searched_profiles_are_selected_after_clearing_search_bar(screen);
	}
	...
	public void enter_different_job_name_substring_for_alternative_validation(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().enter_different_job_name_substring_for_alternative_validation(screen);
	}
	...
	public void validate_second_search_results(String screen) throws IOException, InterruptedException {
		pageObjectManager.getSelectAllWithSearchFunctionality().scroll_down_to_load_all_second_search_results(screen);
	}
	...
	public void verify_all_loaded_profiles_in_second_search_are_not_selected(String screen) throws IOException {
		pageObjectManager.getSelectAllWithSearchFunctionality().verify_all_loaded_profiles_in_second_search_are_not_selected(screen);
	}
}
