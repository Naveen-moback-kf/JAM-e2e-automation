...
public class SD04_JobMappingPageComponents extends DriverManager{	
	...
	public void user_should_be_landed_on_job_profile_mapping_page() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_be_landed_on_job_mapping_page();
	}
	
	@When("User is in Job Mapping page")
	public void user_is_in_job_mapping_page() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_is_in_job_mapping_page();
	}
	...
	public void user_should_verify_job_mapping_logo_is_displayed_on_screen() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_job_mapping_logo_is_displayed_on_screen();
	}
	...
	public void navigate_to_job_mapping_page_from_kfone_global_menu_in_pm() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().navigate_to_job_mapping_page_from_kfone_global_menu_in_pm();
	}
	...
	public void verify_title_header_is_correctly_displaying() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_title_header_is_correctly_displaying();
	}
	...
	public void verify_title_description_below_the_title_header() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_title_description_below_the_title_header();
	}
	...
	public void verify_organization_jobs_search_bar_text_box_is_clickable() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_organization_jobs_search_bar_text_box_is_clickable();
	}
	...
	public void verify_organization_jobs_search_bar_placeholder_text() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_organization_jobs_search_bar_placeholder_text();
	}

	@Then("Enter Job name substring in search bar")
	public void enter_job_name_substring_in_search_bar() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().enter_job_name_substring_in_search_bar();
	}
	...
	public void click_on_matched_profile_of_job_in_first_row() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_matched_profile_of_job_in_first_row();
	}

	@Then("Verify Profile details popup is displayed")
	public void verify_profile_details_popup_is_displayed() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_profile_details_popup_is_displayed();
	}
	...
	public void click_on_close_button_in_profile_details_popup() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_close_button_in_profile_details_popup();
	}
	
	@Then("Click on Filters dropdown button")
	public void click_on_filters_dropdown_button() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_filters_dropdown_button();
	}
	...
	public void verify_options_available_inside_filters_dropdown() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_options_available_inside_filters_dropdown();
	}

	@Then("Close the Filters dropdown")
	public void close_the_filters_dropdown() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().close_the_filters_dropdown();
	}
	...
	public void user_should_see_add_more_jobs_button_is_displaying() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_see_add_more_jobs_button_is_displaying();
	}
	...
	public void verify_add_more_jobs_button_is_clickable() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_add_more_jobs_button_is_clickable();
	}
	
	@Then("Verify User landed on Add more jobs page")
	public void verify_user_landed_on_add_more_jobs_page() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_user_landed_on_add_more_jobs_page();
	}

	@Then("Close Add more jobs page")
	public void close_add_more_jobs_page() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().close_add_more_jobs_page();
	}
	...
	public void user_should_verify_publish_selected_profiles_button_is_disabled() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_publish_selected_profiles_button_is_disabled();
	}
	...
	public void click_on_header_checkbox_to_select_loaded_job_profiles_in_job_mapping_screen() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_header_checkbox_to_select_loaded_job_profiles_in_job_mapping_screen();
	}
	
	@Then("Clear Search bar in Job Mapping page")
	public void clear_search_bar_in_job_mapping_page() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().clear_search_bar_in_job_mapping_page();
	}
	...
	public void user_should_verify_publish_selected_profiles_button_is_enabled() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_publish_selected_profiles_button_is_enabled();
	}
	...
	public void user_should_uncheck_header_checkbox_to_deselect_selected_job_profiles() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_uncheck_header_checkbox_to_deselect_selected_job_profiles();
	}
	
	@Then("Click on checkbox of first job profile")
	public void click_on_checkbox_of_first_job_profile() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_checkbox_of_first_job_profile();
	}

	@Then("Click on checkbox of second job profile")
	public void click_on_checkbox_of_second_job_profile() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_checkbox_of_second_job_profile();
	}
	
	@Then("Click on Publish Selected Profiles button")
	public void click_on_publish_selected_profiles_button() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_publish_selected_profiles_button();
	}
	...
	public void verify_job_profiles_count_is_displaying_on_the_page() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_job_profiles_count_is_displaying_on_the_page();
	}
	...
	public void scroll_page_to_view_more_job_profiles() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().scroll_page_to_view_more_job_profiles();
	}
	...
	public void user_should_verify_count_of_job_profiles_is_correctly_showing_on_top_of_job_profiles_listing_table() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_count_of_job_profiles_is_correctly_showing_on_top_of_job_profiles_listing_table();
	}
	...
	public void user_should_verify_view_published_toggle_button_is_displaying() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_view_published_toggle_button_is_displaying();
	}
	...
	public void user_should_verify_organization_job_name_and_job_code_values_of_first_profile() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_organization_job_name_and_job_code_values_of_first_profile();
	}
	...
	public void user_should_verify_organization_job_grade_and_department_values_of_first_profile() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_organization_job_grade_and_department_values_of_first_profile();
	}
	...
	public void user_should_verify_organization_job_function_or_sub_function_of_first_profile() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_organization_job_function_or_sub_function_of_first_profile();
	}
	...
	public void click_on_toggle_button_to_turn_on() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_toggle_button_to_turn_on();
	}
	...
	public void user_should_verify_published_jobs_are_displaying_in_the_listing_table() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_published_jobs_are_displaying_in_the_listing_table();
	}
	...
	public void click_on_toggle_button_to_turn_off() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_toggle_button_to_turn_off();
	}
	...
	public void user_should_verify_unpublished_jobs_are_displaying_in_the_listing_table() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_unpublished_jobs_are_displaying_in_the_listing_table();
	}
	...
	public void user_should_verify_organization_jobs_table_title_and_headers() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_organization_jobs_table_title_and_headers();
	}
	...
	public void user_should_verify_matched_success_profiles_table_title_and_headers() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_matched_success_profiles_table_title_and_headers();
	}

	@Then("Click on View Other Matches button")
	public void click_on_view_other_matches_button() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().click_on_view_other_matches_button();
	}
	...
	public void verify_user_landed_on_job_compare_page() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingPageComponents().verify_user_landed_on_job_compare_page();
	}
	...
	public void user_should_verify_publish_button_on_matched_success_profile_is_displaying_and_clickable() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_verify_publish_button_on_matched_success_profile_is_displaying_and_clickable();
	}
	...
	public void user_should_get_success_profile_published_popup() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().user_should_get_success_profile_published_popup();
	}
	
	@Then("Close the success profile published popup")
	public void close_the_success_profile_published_popup() throws IOException {
		PageObjectManager.getInstance().getJobMappingPageComponents().close_the_success_profile_published_popup();
	}	
}
