...
public class SD06_PublishSelectedProfiles {	
	public SD06_PublishSelectedProfiles() {
		super();		
	}
	
	@Then("Search for Published Job name1")
	public void search_for_published_job_name1() throws IOException {
		PageObjectManager.getInstance().getPublishSelectedProfiles().search_for_published_job_name1();
	}
	...
	public void user_should_verify_published_first_job_profile_is_displayed_in_row1_in_view_published_screen() throws Exception {
		PageObjectManager.getInstance().getPublishSelectedProfiles().user_should_verify_published_first_job_profile_is_displayed_in_row1_in_view_published_screen();
	}
	
	@Then("Search for Published Job name2")
	public void search_for_published_job_name2() throws IOException {
		PageObjectManager.getInstance().getPublishSelectedProfiles().search_for_published_job_name2();
	}
	...
	public void user_should_verify_published_second_job_profile_is_displayed_in_row1_in_view_published_screen() throws Exception {
		PageObjectManager.getInstance().getPublishSelectedProfiles().user_should_verify_published_second_job_profile_is_displayed_in_row1_in_view_published_screen();
	}
	...
	public void user_should_verify_date_on_published_first_job_matches_with_current_date() throws IOException {
		PageObjectManager.getInstance().getPublishSelectedProfiles().user_should_verify_date_on_published_first_job_matches_with_current_date();
	}
	...
	public void user_should_verify_date_on_published_second_job_matches_with_current_date() throws IOException {
		PageObjectManager.getInstance().getPublishSelectedProfiles().user_should_verify_date_on_published_second_job_matches_with_current_date();
	}
	...
	public void search_for_published_job_name2_in_hcm_sync_profiles_tab_in_pm() throws IOException {
		PageObjectManager.getInstance().getPublishSelectedProfiles().search_for_published_job_name2_in_hcm_sync_profiles_tab_in_pm();
	}
	...
	public void search_for_published_job_code2_in_hcm_sync_profiles_tab_in_pm() throws IOException {
		PageObjectManager.getInstance().getPublishSelectedProfiles().search_for_published_job_code2_in_hcm_sync_profiles_tab_in_pm();
	}
	...
	public void user_should_verify_published_second_job_profile_is_displayed_in_row1_in_hcm_sync_profiles_tab_in_pm() throws Exception {
		PageObjectManager.getInstance().getPublishSelectedProfiles().user_should_verify_published_second_job_profile_is_displayed_in_row1_in_hcm_sync_profiles_tab_in_pm();
	}
