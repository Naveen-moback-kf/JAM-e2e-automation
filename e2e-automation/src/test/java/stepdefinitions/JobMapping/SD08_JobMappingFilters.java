...
public class SD08_JobMappingFilters {	
	...
	public void click_on_grades_filters_dropdown_button() throws IOException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().click_on_filter_dropdown_button("Grades");
	}
	...
	public void select_one_option_in_grades_filters_dropdown() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_one_option_in_grades_filters_dropdown();
	}
	...
	public void validate_job_mapping_profiles_are_correctly_filtered_with_applied_grades_options() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().validate_job_mapping_profiles_are_correctly_filtered_with_applied_grades_options();
	}
	
	@Then("Click on clear\\(x) applied filter")
	public void click_on_clear_x_applied_filter() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().click_on_clear_x_applied_filter();
	}
	...
	public void user_should_scroll_down_to_view_last_result_with_applied_filters() throws IOException, InterruptedException {
		PageObjectManager.getInstance().getJobMappingFilters().user_should_scroll_down_to_view_last_result_with_applied_filters();
	}
	...
	public void select_two_options_in_grades_filters_dropdown() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_two_options_in_grades_filters_dropdown();
	}
	...
	public void select_different_option_in_grades_filters_dropdown() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_different_option_in_grades_filters_dropdown();
	}

	@Then("Click on Clear Filters button")
	public void click_on_clear_filters_button() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().click_on_clear_filters_button();
	}
	...
	public void click_on_departments_filters_dropdown_button() throws InterruptedException, Exception {
	    PageObjectManager.getInstance().getJobMappingFilters().click_on_filter_dropdown_button("Departments");
	}
	...
	public void select_one_option_in_departments_filters_dropdown() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_one_option_in_departments_filters_dropdown();
	}
	...
	public void validate_job_mapping_profiles_are_correctly_filtered_with_applied_departments_options() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().validate_job_mapping_profiles_are_correctly_filtered_with_applied_departments_options();
	}
	...
	public void select_two_options_in_departments_filters_dropdown() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_two_options_in_departments_filters_dropdown();
	}
	...
	public void click_on_functions_subfunctions_filters_dropdown_button() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().click_on_filter_dropdown_button("Functions_SubFunctions");
	}
	...
	public void select_a_function_and_verify_all_subfunctions_inside_function_are_selected_automatically() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_a_function_and_verify_all_subfunctions_inside_function_are_selected_automatically();
	}
	...
	public void validate_job_mapping_profiles_are_correctly_filtered_with_applied_functions_subfunctions_options() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().validate_job_mapping_profiles_are_correctly_filtered_with_applied_functions_subfunctions_options();
	}
	...
	public void user_should_verify_search_bar_is_available_in_functions_subfunctions_filters_dropdown() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().user_should_verify_search_bar_is_available_in_functions_subfunctions_filters_dropdown();
	}
	...
	public void click_inside_search_bar_and_enter_function_name() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().click_inside_search_bar_and_enter_function_name();
	}
	...
	public void user_should_click_on_dropdown_button_of_searched_function_name() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().user_should_click_on_dropdown_button_of_searched_function_name();
	}
	...
	public void select_one_subfunction_option_inside_function_name_dropdown() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_one_subfunction_option_inside_function_name_dropdown();
	}
	...
	public void user_should_verify_function_name_is_automatically_selected_after_selecting_subfunction_option() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().user_should_verify_function_name_is_automatically_selected_after_selecting_subfunction_option();
	}
	...
	public void select_two_subfunction_options_inside_function_name_filters_dropdown() throws InterruptedException, Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_two_subfunction_options_inside_function_name_filters_dropdown();
	}
	...
	public void validate_job_mapping_profiles_are_correctly_filtered_with_applied_grades_departments_and_functions_subfunctions_options() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().validate_job_mapping_profiles_are_correctly_filtered_with_applied_grades_departments_and_functions_subfunctions_options();
	}
	...
	public void click_on_mapping_status_filters_dropdown_button() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().click_on_filter_dropdown_button("MappingStatus");
	}
	...
	public void select_one_option_in_mapping_status_filters_dropdown() throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_one_option_in_mapping_status_filters_dropdown();
	}
	...
	public void click_on_filter_dropdown_button(String filterType) throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().click_on_filter_dropdown_button(filterType);
	}
	...
	public void select_one_option_in_filter_dropdown(String filterType) throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_one_option_in_filter_dropdown(filterType);
	}
	...
	public void select_two_options_in_filter_dropdown(String filterType) throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().select_two_options_in_filter_dropdown(filterType);
	}
	...
	public void validate_filter_results(String filterType) throws Exception {
		PageObjectManager.getInstance().getJobMappingFilters().validate_filter_results(filterType);
	}
