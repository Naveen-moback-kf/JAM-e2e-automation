...
public class SD12_ValidatePersistanceOfFilters {
	PageObjectManager validatePersistanceOfFilters = new PageObjectManager();
	
	public SD12_ValidatePersistanceOfFilters() {
		super();		
	}
	
	@Then("Refresh Job Mapping page")
	public void refresh_job_mapping_page() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().refresh_job_mapping_page();
	}
	...
	public void verify_applied_filters_persist_on_job_mapping_ui() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().verify_applied_filters_persist_on_job_mapping_ui();
	}

	@Then("Click on Browser back button")
	public void click_on_browser_back_button() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().click_on_browser_back_button();
	}
	...
	public void verify_view_published_toggle_button_is_persisted() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().verify_view_published_toggle_button_is_persisted();
	}
	...
	public void verify_applied_sorting_persist_on_job_mapping_ui() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().verify_applied_sorting_persist_on_job_mapping_ui();
	}
	...
	public void user_is_in_job_mapping_page_with_grades_filters_applied() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().user_is_in_job_mapping_page_with_grades_filters_applied();
	}
	...
	public void user_is_in_job_mapping_page_with_mapping_status_filters_applied() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().user_is_in_job_mapping_page_with_mapping_status_filters_applied();
	}
	...
	public void user_is_in_view_published_screen_with_grades_filters_applied() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().user_is_in_view_published_screen_with_grades_filters_applied();
	}
	...
	public void user_is_in_view_published_screen_with_multiple_filters_applied() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().user_is_in_view_published_screen_with_multiple_filters_applied();
	}
	...
	public void user_is_in_job_mapping_page_with_multi_level_sorting_applied() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().user_is_in_job_mapping_page_with_multi_level_sorting_applied();
	}
	...
	public void user_is_in_job_mapping_page_with_sorting_and_filters_applied() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().user_is_in_job_mapping_page_with_sorting_and_filters_applied();
	}
	...
	public void user_is_in_view_published_screen_with_sorting_applied() throws IOException {
		validatePersistanceOfFilters.getValidatePersistanceOfFilters().user_is_in_view_published_screen_with_sorting_applied();
	}
