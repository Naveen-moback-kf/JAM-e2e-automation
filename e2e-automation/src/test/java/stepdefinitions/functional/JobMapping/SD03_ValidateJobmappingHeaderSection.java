...
public class SD03_ValidateJobmappingHeaderSection {
	PageObjectManager validateJobmappingHeaderSection = new PageObjectManager();
	
	public SD03_ValidateJobmappingHeaderSection() {
		super();		
	}
	
	@Then("Verify KF Talent Suite logo is displaying")
	public void verify_kf_talent_suite_logo_is_displaying() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().verify_kf_talent_suite_logo_is_displaying();
	}
	
	@Then("Click on KF Talent Suite logo")
	public void click_on_kf_talent_suite_logo() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().click_on_kf_talent_suite_logo();
	}
	...
	public void navigate_to_job_mapping_page_from_kfone_global_menu() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().navigate_to_job_mapping_page_from_kfone_global_menu();
	}
	...
	public void user_should_verify_client_name_is_correctly_displaying() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().user_should_verify_client_name_is_correctly_displaying();
	}
	...
	public void click_on_client_name_in_job_mapping_ui_header() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().click_on_client_name_in_job_mapping_ui_header();
	}
	...
	public void verify_user_navigated_to_kfone_clients_page() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().verify_user_navigated_to_kfone_clients_page();
	}
	...
	public void verify_user_profile_logo_is_displaying_and_clickable() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().verify_user_profile_logo_is_displaying_and_clickable();
	}

	@Then("Verify User Profile Menu is opened")
	public void verify_user_profile_menu_is_opened() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().verify_user_profile_menu_is_opened();
	}
	...
	public void verify_user_name_is_displayed_in_profile_menu() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().verify_user_name_is_displayed_in_profile_menu();
	}
	...
	public void verify_user_email_is_displayed_in_profile_menu() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().verify_user_email_is_displayed_in_profile_menu();
	}
	...
	public void click_on_signout_button_in_user_profile_menu() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().click_on_signout_button_in_user_profile_menu();
	}
	...
	public void user_should_be_signed_out_from_the_application() throws IOException {
		validateJobmappingHeaderSection.getValidateJobmappingHeaderSection().user_should_be_signed_out_from_the_application();
	}
