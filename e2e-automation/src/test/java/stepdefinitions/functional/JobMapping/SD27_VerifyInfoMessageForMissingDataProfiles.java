...
public class SD27_VerifyInfoMessageForMissingDataProfiles extends DriverManager {
	PageObjectManager verifyInfoMessageForMissingDataProfiles = new PageObjectManager();
	
	public SD27_VerifyInfoMessageForMissingDataProfiles() {
		super();		
	}
	...
	public void find_and_verify_profile_with_missing_data_has_info_message_displayed() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().find_and_verify_profile_with_missing_data_has_info_message_displayed();
	}
	...
	public void verify_info_message_contains_text_about_reduced_match_accuracy_due_to_missing_data() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().verify_info_message_contains_text_about_reduced_match_accuracy_due_to_missing_data();
	}
	...
	public void find_and_verify_second_profile_with_missing_data_has_info_message_displayed() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().find_and_verify_second_profile_with_missing_data_has_info_message_displayed();
	}
	...
	public void verify_info_message_contains_text_about_reduced_match_accuracy_due_to_missing_data_for_second_profile() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().verify_info_message_contains_text_about_reduced_match_accuracy_due_to_missing_data_for_second_profile();
	}
	...
	public void find_profile_with_missing_data_and_info_message() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().find_profile_with_missing_data_and_info_message();
	}
	...
	public void find_second_profile_with_missing_data_and_info_message() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().find_second_profile_with_missing_data_and_info_message();
	}
	...
	public void extract_job_details_from_profile_with_info_message() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().extract_job_details_from_profile_with_info_message();
	}
	...
	public void extract_job_details_from_job_comparison_page() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().extract_job_details_from_job_comparison_page();
	}
	...
	public void verify_job_details_match_between_job_mapping_and_job_comparison_pages() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().verify_job_details_match_between_job_mapping_and_job_comparison_pages();
	}
	...
	public void extract_job_details_from_second_profile_with_info_message() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().extract_job_details_from_second_profile_with_info_message();
	}
	...
	public void extract_job_details_from_job_comparison_page_for_second_profile() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().extract_job_details_from_job_comparison_page_for_second_profile();
	}
	...
	public void verify_job_details_match_between_job_mapping_and_job_comparison_pages_for_second_profile() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().verify_job_details_match_between_job_mapping_and_job_comparison_pages_for_second_profile();
	}
	...
	public void click_on_button_for_profile_with_info_message(String buttonText) throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().click_on_button_for_profile_with_info_message(buttonText);
	}
	...
	public void click_on_button_for_second_profile_with_info_message(String buttonText) throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().click_on_button_for_second_profile_with_info_message(buttonText);
	}
	...
	public void verify_user_is_navigated_to_job_comparison_page() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().verify_user_is_navigated_to_job_comparison_page();
	}
	...
	public void verify_info_message_is_still_displayed_in_job_comparison_page() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().verify_info_message_is_still_displayed_in_job_comparison_page();
	}
	...
	public void verify_info_message_contains_same_text_about_reduced_match_accuracy() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().verify_info_message_contains_same_text_about_reduced_match_accuracy();
	}
	...
	public void verify_info_message_is_still_displayed_in_job_comparison_page_for_second_profile() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().verify_info_message_is_still_displayed_in_job_comparison_page_for_second_profile();
	}
	...
	public void verify_info_message_contains_same_text_about_reduced_match_accuracy_for_second_profile() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().verify_info_message_contains_same_text_about_reduced_match_accuracy_for_second_profile();
	}
	...
	public void navigate_back_to_job_mapping_page_from_job_comparison() throws IOException {
		verifyInfoMessageForMissingDataProfiles.getVerifyInfoMessageForMissingDataProfiles().navigate_back_to_job_mapping_page_from_job_comparison();
	}
