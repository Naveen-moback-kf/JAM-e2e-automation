...
public class Runner09_PublishSelectedProfiles extends CustomizeTestNGCucumberRunner {
	...
	public void after_test() {
		LOGGER.info("Successfully completed testing the functionality of publishing selected profiles");
