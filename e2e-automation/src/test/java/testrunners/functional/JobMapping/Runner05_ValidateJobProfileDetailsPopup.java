...
public class Runner05_ValidateJobProfileDetailsPopup extends CustomizeTestNGCucumberRunner {
	...
	public void after_test() {
		LOGGER.info("Successfully completed testing of Job Profile Details Popup screen");
