...
@CucumberOptions(
		...
		tags = "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Select_HCM_Sync_Loaded_Profiles_With_Search_PM",
...
public class Runner35a_ValidateLoadedProfilesSelectionWithSearch_PM extends CustomizeTestNGCucumberRunner {
	...
	protected String getTagExpressionTemplate() {
		return "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Select_HCM_Sync_Loaded_Profiles_With_Search_PM";
	}
