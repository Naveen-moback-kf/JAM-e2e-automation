...
@CucumberOptions(
		...
		tags = "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Clear_Profile_Selection_With_None_Button_JAM",
...
public class Runner45_ClearProfileSelectionwithNoneButton_JAM extends CustomizeTestNGCucumberRunner {
	...
	protected String getTagExpressionTemplate() {
		return "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Clear_Profile_Selection_With_None_Button_JAM";
	}
