...
@CucumberOptions(
		features = {
			...
			"src/test/resources/features/JobMapping/38aValidateLoadedProfilesSelectionWithSearch_JAM.feature"
		},
		tags = "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @Select_Loaded_Profiles_With_Search_JAM",
...
public class Runner38a_ValidateLoadedProfilesSelectionWithSearch_JAM extends CustomizeTestNGCucumberRunner {
	...
	protected String getTagExpressionTemplate() {
		return "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @Select_Loaded_Profiles_With_Search_JAM";
	}
