...
@CucumberOptions(
		features = {
			...
			"src/test/resources/features/JobMapping/36ValidateSelectAllWithFiltersFunctionality_PM.feature"
		},
		tags = "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @SelectAll_With_Filters_Functionality_in_HCM_PM",
...
public class Runner36_ValidateSelectAllWithFiltersFunctionality_PM extends CustomizeTestNGCucumberRunner {
	...
	protected String getTagExpressionTemplate() {
		return "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @SelectAll_With_Filters_Functionality_in_HCM_PM";
	}
