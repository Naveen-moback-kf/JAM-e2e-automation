...
@CucumberOptions(
		...
		tags = "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @Validate_Grade_Filters",
...
public class Runner11a_ValidateGradeFilters extends CustomizeTestNGCucumberRunner {
	...
	protected String getTagExpressionTemplate() {
		return "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @Validate_Grade_Filters";
	}
