...
public class Runner35_ValidateSelectAllWithSearchFunctionality_PM extends CustomizeTestNGCucumberRunner {
	...
	public void after_test() {
		LOGGER.info("Successfully completed validation of Select All with Search Functionality in HCM Sync Profiles screen");
