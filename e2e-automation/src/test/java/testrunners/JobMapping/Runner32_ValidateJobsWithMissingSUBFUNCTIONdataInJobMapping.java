...
public class Runner32_ValidateJobsWithMissingSUBFUNCTIONdataInJobMapping extends CustomizeTestNGCucumberRunner {
	...
	public void after_test() {
		LOGGER.info("Successfully completed validation of Jobs with Missing SUBFUNCTION Data in Job Mapping workflow");
