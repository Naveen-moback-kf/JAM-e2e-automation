...
@CucumberOptions(
		...
		tags = "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @Validate_Jobs_With_Missing_DEPARTMENT_Data_In_JobMapping",
...
public class Runner30_ValidateJobsWithMissingDEPARTMENTdataInJobMapping extends CustomizeTestNGCucumberRunner {
	...
	protected String getTagExpressionTemplate() {
		return "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @Validate_Jobs_With_Missing_DEPARTMENT_Data_In_JobMapping";
	}
