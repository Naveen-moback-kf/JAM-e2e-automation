 ...
 * Tests: Grade Filters functionality across browsers
 */
@Listeners({
...
public class CrossBrowser11a_ValidateGradeFiltersRunner extends CustomizeTestNGCucumberRunner {
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Grade Filters Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Grade Filters on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    synchronized(CrossBrowser11a_ValidateGradeFiltersRunner.class) {
            ...
            LOGGER.info("{} browser Grade Filters testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Grade Filters test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
