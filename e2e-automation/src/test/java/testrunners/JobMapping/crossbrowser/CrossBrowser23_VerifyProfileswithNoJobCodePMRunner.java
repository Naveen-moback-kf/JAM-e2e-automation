...
/**
 * Cross-Browser Profiles with No Job Code PM Test Runner
 * 
 * Command: mvn test -Dtest=CrossBrowser23_VerifyProfileswithNoJobCodePMRunner
 * Result: Chrome + Firefox + Edge run automatically
 * Tests: Profiles with No Job Code verification in Profile Manager across browsers
 * 
 * @author AI Assistant
 */
@Listeners({
...
public class CrossBrowser23_VerifyProfileswithNoJobCodePMRunner extends CustomizeTestNGCucumberRunner {
     ...
     * 
     * @return The tag expression template for Cross-Browser Verify Profiles with No JobCode PM validation
     */
    @Override
    protected String getTagExpressionTemplate() {
        return "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Verify_Profiles_with_No_JobCode_in_PM";
    }    
    @Override
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Profiles with No Job Code PM Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Profiles with No Job Code PM on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    ...
                    synchronized(CrossBrowser23_VerifyProfileswithNoJobCodePMRunner.class) {
            ...
            LOGGER.info("{} browser Profiles with No Job Code PM testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Profiles with No Job Code PM test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
