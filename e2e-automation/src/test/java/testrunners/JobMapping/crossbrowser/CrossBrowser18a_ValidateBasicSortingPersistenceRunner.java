 ...
 * Tests: Basic Sorting Persistence functionality across browsers
 */
@Listeners({
...
public class CrossBrowser18a_ValidateBasicSortingPersistenceRunner extends CustomizeTestNGCucumberRunner {
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Basic Sorting Persistence Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Basic Sorting Persistence on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    synchronized(CrossBrowser18a_ValidateBasicSortingPersistenceRunner.class) {
            ...
            LOGGER.info("{} browser Basic Sorting Persistence testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Basic Sorting Persistence test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
