 ...
 * Tests: Department Filters functionality across browsers
 */
@Listeners({
...
public class CrossBrowser11b_ValidateDepartmentFiltersRunner extends CustomizeTestNGCucumberRunner {
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Department Filters Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Department Filters on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    synchronized(CrossBrowser11b_ValidateDepartmentFiltersRunner.class) {
            ...
            LOGGER.info("{} browser Department Filters testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Department Filters test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
