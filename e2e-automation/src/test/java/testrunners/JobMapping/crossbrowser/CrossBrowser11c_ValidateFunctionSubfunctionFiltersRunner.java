...
/**
 * Cross-Browser Function and Subfunction Filters Test Runner
 * 
 * Command: mvn test -Dtest=CrossBrowser11c_ValidateFunctionSubfunctionFiltersRunner
 * Result: Chrome + Firefox + Edge run automatically
 * Tests: Function/Subfunction Filters functionality across browsers
 */
@Listeners({
...
@CucumberOptions(
    ...
    tags = "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Validate_Function_Subfunction_Filters",
		glue = {"stepdefinitions.JobMapping", "hooks.JobMapping"},
    dryRun = false,
    plugin = {"html:target/cucumber-reports/cucumber.html", "json:target/cucumber-reports/cucumber.json"}
)
public class CrossBrowser11c_ValidateFunctionSubfunctionFiltersRunner extends CustomizeTestNGCucumberRunner {
    ...
    protected String getTagExpressionTemplate() {
        return "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Validate_Function_Subfunction_Filters";
    }    
    @Override
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Function/Subfunction Filters Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Function/Subfunction Filters on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    synchronized(CrossBrowser11c_ValidateFunctionSubfunctionFiltersRunner.class) {
            ...
            LOGGER.info("{} browser Function/Subfunction Filters testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Function/Subfunction Filters test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
