 ...
 * 
 * Command: mvn test -Dtest=CrossBrowser20_PublishCenter_PMRunner
...
@CucumberOptions(
    features = {
        ...
        "src/test/resources/features/JobMapping/20_PublishCenter_PM.feature"
    },
...
public class CrossBrowser20_PublishCenter_PMRunner extends CrossBrowserCucumberRunner {
