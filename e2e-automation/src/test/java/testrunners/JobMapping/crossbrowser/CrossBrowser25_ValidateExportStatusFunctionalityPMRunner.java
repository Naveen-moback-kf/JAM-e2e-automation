...
/**
 * Cross-Browser Validate Export Status Functionality PM Test Runner
 * 
 ...
 * Tests: Export Status functionality validation in Profile Manager across browsers
 * 
 * @author AI Assistant
 */
@Listeners({
...
public class CrossBrowser25_ValidateExportStatusFunctionalityPMRunner extends CustomizeTestNGCucumberRunner {
     ...
     * 
     * @return The tag expression template for Cross-Browser Export Status Functionality PM validation
     */
    @Override
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Export Status Functionality PM Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Export Status functionality PM on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    ...
                    synchronized(CrossBrowser25_ValidateExportStatusFunctionalityPMRunner.class) {
            ...
            LOGGER.info("{} browser Export Status functionality PM testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Export Status functionality PM test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
