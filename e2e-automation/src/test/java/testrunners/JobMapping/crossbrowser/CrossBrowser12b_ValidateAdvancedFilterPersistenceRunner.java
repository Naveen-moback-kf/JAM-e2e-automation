...
/**
 * Cross-Browser Advanced Filter Persistence Test Runner
 * 
 * Command: mvn test -Dtest=CrossBrowser12b_ValidateAdvancedFilterPersistenceRunner
 * Result: Chrome + Firefox + Edge run automatically
 * Tests: Advanced Filter Persistence functionality across browsers
 */
@Listeners({
...
@CucumberOptions(
		...
		tags = "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Validate_Advanced_Filter_Persistence",
		glue = {"stepdefinitions.JobMapping", "hooks.JobMapping"},
		dryRun = false,
    plugin = {"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
		)
public class CrossBrowser12b_ValidateAdvancedFilterPersistenceRunner extends CustomizeTestNGCucumberRunner {
	...
	protected String getTagExpressionTemplate() {
		return "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Validate_Advanced_Filter_Persistence";
	}    
    @Override
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Advanced Filter Persistence Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Advanced Filter Persistence on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    synchronized(CrossBrowser12b_ValidateAdvancedFilterPersistenceRunner.class) {
            ...
            LOGGER.info("{} browser Advanced Filter Persistence testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Advanced Filter Persistence test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
