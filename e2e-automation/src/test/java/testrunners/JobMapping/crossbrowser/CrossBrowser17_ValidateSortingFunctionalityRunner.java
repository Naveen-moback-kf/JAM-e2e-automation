 ...
 * Tests: Job Mapping sorting functionality across browsers
 * 
 * @author AI Assistant
 */
@Listeners({
...
public class CrossBrowser17_ValidateSortingFunctionalityRunner extends CustomizeTestNGCucumberRunner {
     ...
     * 
     * @return The tag expression template for Cross-Browser Sorting Functionality validation
     */
    @Override
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Sorting Functionality Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Sorting functionality on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    ...
                    synchronized(CrossBrowser17_ValidateSortingFunctionalityRunner.class) {
            ...
            LOGGER.info("{} browser Sorting functionality testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Sorting functionality test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
