...
/**
 * Cross-Browser Validate Jobs With Missing FUNCTION Data In JobMapping Test Runner
 * 
 * Command: mvn test -Dtest=CrossBrowser31_ValidateJobsWithMissingFUNCTIONdataInJobMappingRunner
 * Result: Chrome + Firefox + Edge run automatically
 * Tests: Jobs with Missing FUNCTION Data validation in Job Mapping across browsers
 * 
 * @author AI Assistant
 */
@Listeners({
...
public class CrossBrowser31_ValidateJobsWithMissingFUNCTIONdataInJobMappingRunner extends CustomizeTestNGCucumberRunner {
     ...
     * 
     * @return The tag expression template for Cross-Browser Validate Jobs with Missing FUNCTION Data in JobMapping validation
     */
    @Override
    protected String getTagExpressionTemplate() {
        return "@DYNAMIC_LOGIN or @Client_with_PM_Access or @Validate_Jobs_With_Missing_FUNCTION_Data_In_JobMapping";
    }    
    @Override
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Jobs With Missing FUNCTION Data Validation Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Jobs With Missing FUNCTION Data validation on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    ...
                    synchronized(CrossBrowser31_ValidateJobsWithMissingFUNCTIONdataInJobMappingRunner.class) {
            ...
            LOGGER.info("{} browser Jobs With Missing FUNCTION Data testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Jobs With Missing FUNCTION Data test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
