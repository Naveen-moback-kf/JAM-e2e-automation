 ...
 * Tests: Select All Profiles and Sync with HCM in HCM Sync Profiles screen across browsers
 * 
 * @author AI Assistant
 */
@Listeners({
...
public class CrossBrowser33_ValidateSelectAndSyncAllProfilesPMRunner extends CustomizeTestNGCucumberRunner {
     ...
     * 
     * @return The tag expression template for Cross-Browser Select and Sync All Profiles validation
     */
    @Override
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Select and Sync All Profiles Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Select and Sync All Profiles validation on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    ...
                    synchronized(CrossBrowser33_ValidateSelectAndSyncAllProfilesPMRunner.class) {
            ...
            LOGGER.info("{} browser Select and Sync All Profiles testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Select and Sync All Profiles test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
