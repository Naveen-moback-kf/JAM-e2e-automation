 ...
 * Tests: Profile Collections Restricted Tip Message functionality across browsers
 * 
 * @author AI Assistant
 */
@Listeners({
...
public class CrossBrowser16_ValidatePCRestrictedTipMessageRunner extends CustomizeTestNGCucumberRunner {
     ...
     * 
     * @return The tag expression template for Cross-Browser PC Restricted Tip Message validation
     */
    @Override
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser PC Restricted Tip Message Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for PC Restricted Tip Message functionality on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    ...
                    synchronized(CrossBrowser16_ValidatePCRestrictedTipMessageRunner.class) {
            ...
            LOGGER.info("{} browser PC Restricted Tip Message testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser PC Restricted Tip Message test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
