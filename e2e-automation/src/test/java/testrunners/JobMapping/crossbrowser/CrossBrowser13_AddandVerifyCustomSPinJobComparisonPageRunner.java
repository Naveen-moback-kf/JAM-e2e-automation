 ...
 * Tests: Custom Success Profile functionality in Job Comparison Page across browsers
 * 
 * @author AI Assistant
 */
@Listeners({
...
public class CrossBrowser13_AddandVerifyCustomSPinJobComparisonPageRunner extends CustomizeTestNGCucumberRunner {
     ...
     * 
     * @return The tag expression template for Cross-Browser Custom SP in Job Comparison Page validation
     */
    @Override
    ...
    @Test(dataProvider = "browsers", description = "Cross-Browser Custom SP in Job Comparison Page Testing")
    public void runCrossBrowserTest(String browserName, String browserVersion, String platform) {
        ...
        try {
            ...
            LOGGER.info("Running {} scenarios for Custom SP in Job Comparison Page on {}", scenarios.length, browserName.toUpperCase());
            ...
            for (Object[] scenario : scenarios) {
                ...
                try {
                    ...
                    synchronized(CrossBrowser13_AddandVerifyCustomSPinJobComparisonPageRunner.class) {
            ...
            LOGGER.info("{} browser Custom SP in Job Comparison Page testing completed", browserName.toUpperCase());
            
        } catch (Exception e) {
            LOGGER.error("{} browser Custom SP in Job Comparison Page test failed: {}", browserName.toUpperCase(), e.getMessage());
        } finally {
