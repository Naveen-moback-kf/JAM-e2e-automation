...
@CucumberOptions(
		features = {
			...
			"src/test/resources/features/JobMapping/38ValidateSelectAllWithSearchFunctionality_JAM.feature"
		},
		tags = "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @SelectAll_With_Search_Functionality_in_JAM",
...
public class Runner38_ValidateSelectAllWithSearchFunctionality_JAM extends CustomizeTestNGCucumberRunner {
	...
	protected String getTagExpressionTemplate() {
		return "@SSO_Login_via_KFONE or @NON_SSO_Login_via_KFONE or @Client_with_PM_Access or @SelectAll_With_Search_Functionality_in_JAM";
	}
