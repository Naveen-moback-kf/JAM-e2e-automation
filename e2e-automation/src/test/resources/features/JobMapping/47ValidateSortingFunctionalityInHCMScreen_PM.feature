...
Feature: Validate Sorting of Profiles in HCM Sync Profiles screen
    ...
    @SortByLastModified_Ascending_Function_Descending
  	Scenario: Validate sorting of Profiles by Last Modified Date in Ascending Order and Function in Descending Order in HCM Screen
  		When User is in HCM Sync Profiles screen
    ...
    @SortByLastModified_ExportStatus_Function_ThreeLevel
  	Scenario: Validate three level sorting by Last Modified Ascending, Export Status Descending and Function Ascending in HCM Screen
  		When User is in HCM Sync Profiles screen
    	Then Sort Profiles by Last Modified in Ascending order in HCM Sync Profiles screen
